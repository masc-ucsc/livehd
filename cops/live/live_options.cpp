...
Live_pass_pack::Live_pass_pack(int argc, const char **argv) {
  ...
  Options::get_desc()->add_options()("original_lgdb,o", boost::program_options::value(&original_lgdb)->required(), "lgdb path of the original netlist")("modified_lgdb,m", boost::program_options::value(&modified_lgdb)->required(), "lgdb path of the modified netlist")("synth_lgdb,s", boost::program_options::value(&synth_lgdb)->required(), "lgdb path of the synthesized netlist")("delta_lgdb,s", boost::program_options::value(&delta_lgdb), "lgdb path for the generated delta lgraph (default olgdb)")("boundaries,b", boost::program_options::value(&boundaries_name)->required(), "invariant boundaries files generated by lginvariant")("diff,d", boost::program_options::value(&diff_file), "file containing different boundaries (default=diff)")("help,h", "print usage message");
