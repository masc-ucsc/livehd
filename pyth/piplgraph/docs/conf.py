...
latex_documents = [
    (master_doc, 'lgraph.tex', u'lgraph Documentation',
...
man_pages = [
    (master_doc, 'lgraph', u'lgraph Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'lgraph', u'lgraph Documentation',
     author, 'lgraph', 'One line description of project.',
     'Miscellaneous'),
]
