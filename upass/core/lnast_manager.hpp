...
public:
  ...
  // variables don't collide with caller (or other call-site) names. const
  // names (literals / attr-keys) are never rewritten. The rewritten string
  // is interned so the view stays valid.
