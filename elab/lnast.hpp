...
private:
  ...
  const mmap_lib:str &create_tmp_var();
...
public:
  ...
  ~Lnast();
  explicit Lnast(const mmap_lib:str &_module_name) : top_module_name(_module_name), source_filename(""), memblock_fd(-1) {}
  ...
  explicit Lnast(const mmap_lib:str &_module_name, std::pair<mmap_lib::str, int> o)
      : top_module_name(_module_name), source_filename(""), memblock(o.first), memblock_fd(o.second) {}
  explicit Lnast(const mmap_lib:str &_module_name, const mmap_lib:str &_file_name, std::pair<mmap_lib::str, int> o)
  ...
  bool             is_register(const mmap_lib:str &name) { return name.at(0) == '#'; }
  bool             is_output(const mmap_lib:str &name) { return name.at(0) == '%'; }
  bool             is_input(const mmap_lib:str &name) { return name.at(0) == '$'; }
