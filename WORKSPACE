...
http_archive(
    ...
    sha256 = "e0a092e22130c3146144c76bb18434bf711219548fceddcca03bf7036cfe41ba",
    strip_prefix = "cryptominisat-5.11.21",
    urls = [
        "https://github.com/msoos/cryptominisat/archive/refs/tags/5.11.21.zip",
    ],
)
