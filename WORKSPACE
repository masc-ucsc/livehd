...
http_archive(
   ...
   urls = [
     "https://github.com/YosysHQ/yosys/archive/refs/tags/v0.50.zip",
   ],
   sha256 = "7bc918cae2aeca4f80be0adc4fee55d3cdc245882d176f6f89e89f2d28125066",
   strip_prefix = "yosys-0.50",
