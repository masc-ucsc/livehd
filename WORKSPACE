...
http_archive(
    ...
    sha256 = "eb2d8bfcb6d21b820ac88add96d71ef9ebaec9d2a171b86a48c27c0511a17e4e",
    strip_prefix = "tree-sitter-0.22.6",
    urls = [
        "https://github.com/tree-sitter/tree-sitter/archive/refs/tags/v0.22.6.zip",
    ],
)
