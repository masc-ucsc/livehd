...
http_archive(
    ...
    sha256 = "67690cf9f5d3a79a1eaaee565545f7b094aaaf4aabbaee786f33458becd30d7d",
    strip_prefix = "tree-sitter-0.25.5",
    urls = [
        "https://github.com/tree-sitter/tree-sitter/archive/refs/tags/v0.25.5.zip",
    ],
)
