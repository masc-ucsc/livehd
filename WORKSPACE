...
http_archive(
    ...
    strip_prefix = "hif-63653ffaae735f3d183c071c66e319cdfd38a2fe",
    urls = [
        "https://github.com/masc-ucsc/hif/archive/63653ffaae735f3d183c071c66e319cdfd38a2fe.zip",
    ],
)
...
http_archive(
    ...
    strip_prefix = "OpenTimer-e3a9d9e95b7b23dcf7a3aa96c9939d1ab88bba27",
    urls = [
        "https://github.com/masc-ucsc/OpenTimer/archive/e3a9d9e95b7b23dcf7a3aa96c9939d1ab88bba27.zip",
    ],
)
