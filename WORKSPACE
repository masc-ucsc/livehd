...
http_archive(
    ...
    sha256 = "8a0eaa38ffc82007a3074ac44b73e29297371df8a387eb9d551f4d558ada9b82",
    strip_prefix = "cryptominisat-5.11.22",
    urls = [
        "https://github.com/msoos/cryptominisat/archive/refs/tags/5.11.22.zip",
    ],
)
