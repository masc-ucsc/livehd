...
http_archive(
   ...
   urls = [
     "https://github.com/YosysHQ/yosys/archive/refs/tags/0.46.zip",
   ],
   sha256 = "538ca536cf60030be25b094667d6c76b87098ae93c26e55421667440f2fcfc98",
   strip_prefix = "yosys-0.46",
