...
http_archive(
    ...
    sha256 = "e0ef32587948b62853d03744f795c6a49f53b1c3dc772b8ba0013b841c0e07f0",
    strip_prefix = "tree-sitter-0.25.2",
    urls = [
        "https://github.com/tree-sitter/tree-sitter/archive/refs/tags/v0.25.2.zip",
    ],
)
