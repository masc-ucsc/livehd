...
"$LHD" lec  --set formal.engine=bmc --top pstruct \
...
EOF
"$LHD" lec  --set formal.engine=bmc --top psigned \
...
EOF
"$LHD" lec  --set formal.lec.semdiff=none --set formal.engine=ind \
...
"$LHD" lec  --set formal.engine=ind --top packed_sub_boundary \
