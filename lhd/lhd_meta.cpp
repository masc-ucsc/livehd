...
constexpr std::string_view kEmitKinds =
    R"json(["ln","lg","verilog","pyrope","lnast-dump","isabelle","graphviz","metadata","results","diagnostics"])json";
...
void print_general_help() {
  std::print(
      ...
      "  ln:/lg:/lnast-dump:/isabelle: are directory containers (--emit-dir only);\n"
...
int help_command(const Options& opts) {
  ...
  if (topic == "compile") {
    std::print(
        ...
        "  --emit-dir K:DIR/    lg: | ln: | verilog: | pyrope: | lnast-dump: | isabelle:\n"
