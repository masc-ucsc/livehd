...
def fastM1 (i : RuntimeInput) (s : RuntimeState) : RuntimeResult :=
...
theorem fastM1_correct : ∀ i s, fastM1 i s = denoteResidual RM1 i s := by
  intro i s
  simp [fastM1, denoteResidual, RM1, runBindings, sourceEnvArr, denoteExpr, refBVs, refBV, denoteRef, sourceValue, CertVal.asBV]
