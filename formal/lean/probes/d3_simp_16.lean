...
def fast16 (i : RuntimeInput) (s : RuntimeState) : RuntimeResult :=
...
theorem fast16_correct : ∀ i s, fast16 i s = denoteResidual R16 i s := by
  intro i s
  simp [fast16, denoteResidual, R16, runBindings, sourceEnvArr, denoteExpr, refBVs, refBV, denoteRef, sourceValue, CertVal.asBV]
