`ifndef LIVEHD_CGEN_MEMORY_4RD_1WR_V
`define LIVEHD_CGEN_MEMORY_4RD_1WR_V
  ...
  for(fwd_j2=0;fwd_j2<WENSIZE;fwd_j2=fwd_j2+1) begin:FWD_BLOCK_CALC_2
    always_comb begin
      d2_fwd[fwd_j2*MASKSIZE +: MASKSIZE] =
        (((UNDEF >> 2) & 1) != 0 && wr_enable_0[fwd_j2] && (wr_addr_0 == rd_addr_2)) ?
        {MASKSIZE{1'bx}} :
        (((FWD >> 2) & 1) != 0 && wr_enable_0[fwd_j2] && (wr_addr_0 == rd_addr_2)) ?
  ...
  for(fwd_j3=0;fwd_j3<WENSIZE;fwd_j3=fwd_j3+1) begin:FWD_BLOCK_CALC_3
    always_comb begin
      d3_fwd[fwd_j3*MASKSIZE +: MASKSIZE] =
        (((UNDEF >> 3) & 1) != 0 && wr_enable_0[fwd_j3] && (wr_addr_0 == rd_addr_3)) ?
        {MASKSIZE{1'bx}} :
        (((FWD >> 3) & 1) != 0 && wr_enable_0[fwd_j3] && (wr_addr_0 == rd_addr_3)) ?
...
`endif // LIVEHD_CGEN_MEMORY_4RD_1WR_V
