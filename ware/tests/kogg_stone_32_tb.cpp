...
void advance_clock(Vkogg_stone_32 *top, int nclocks = 1) {
...
int main(int argc, char **argv, char **env) {
  ...
  Vkogg_stone_32 *top = new Vkogg_stone_32;

  uint32_t val_a[NUM_TESTS] = {(uint32_t)1 << 13, 0, 0x0AAAAAAA, (uint32_t)1 << 30};

  uint32_t val_b[NUM_TESTS] = {(uint32_t)1 << 13, 0, 0x0AAAAAAA, (uint32_t)1 << 30};
