...
#include "Vshift_barrelfast_sright.h"
#include "verilated.h"
...
void advance_clock(Vshift_barrelfast_sright *top, int nclocks=1) {
...
int main(int argc, char **argv, char **env) {
  ...
  Vshift_barrelfast_sright* top = new Vshift_barrelfast_sright;
