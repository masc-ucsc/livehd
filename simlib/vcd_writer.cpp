...
//public:
  VCDWriter& initialize_vcd_writer(){
    ...
    if (var) {
       dump_directory_ = dump_directory + "/" + "SIMLIB_VCD.vcd";
    } else {
       dump_directory_="SIMLIB_VCD.vcd";
    }
    static VCDWriter writer{dump_directory_, makeVCDHeader(TimeScale::ONE, TimeScaleUnit::ns, utils::now(), "This is the VCD file", "generated by SimLibVCD") };
    return writer;
  }
//};
}
