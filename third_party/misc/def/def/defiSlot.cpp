...
defiSlot::defiSlot(defrData* data) : defData(data) { Init(); }
...
int defiSlot::hasLayer() const { return hasLayer_; }

const char* defiSlot::layerName() const { return layerName_; }

int defiSlot::numRectangles() const { return numRectangles_; }
