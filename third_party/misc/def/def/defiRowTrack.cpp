...
defiRow::defiRow(defrData* data) : defData(data) { Init(); }
...
void defiRow::setup(const char* name, const char* macro, double x, double y, int orient) {
...
void defiRow::setHasDoStep() { hasDoStep_ = 1; }
...
void defiRow::addNumProperty(const char* name, const double d, const char* value, const char type) {
  int len;
  if (numProps_ == propsAllocated_) {
    int     i;
    char**  nn;
...
const char* defiRow::name() const { return name_; }

const char* defiRow::macro() const { return macro_; }

double defiRow::x() const { return x_; }

double defiRow::y() const { return y_; }

double defiRow::xNum() const { return xNum_; }

double defiRow::yNum() const { return yNum_; }

int defiRow::orient() const { return orient_; }

const char* defiRow::orientStr() const { return (defiOrientStr(orient_)); }

int defiRow::hasDo() const { return hasDo_; }

int defiRow::hasDoStep() const { return hasDoStep_; }

double defiRow::xStep() const { return xStep_; }

double defiRow::yStep() const { return yStep_; }

void defiRow::print(FILE* f) const {
  fprintf(f, "Row '%s' '%s' %g,%g  orient %s\n", name(), macro(), x(), y(), orientStr());
...
defiTrack::defiTrack(defrData* data) : defData(data) { Init(); }
...
const char* defiTrack::macro() const { return macro_; }

double defiTrack::x() const { return x_; }

double defiTrack::xNum() const { return xNum_; }

double defiTrack::xStep() const { return xStep_; }

int defiTrack::numLayers() const { return numLayers_; }
...
int defiTrack::firstTrackMask() const { return firstTrackMask_; }

int defiTrack::sameMask() const { return samemask_; }
...
defiGcellGrid::defiGcellGrid(defrData* data) : defData(data) { Init(); }
...
int defiGcellGrid::x() const { return x_; }

int defiGcellGrid::xNum() const { return xNum_; }

double defiGcellGrid::xStep() const { return xStep_; }

const char* defiGcellGrid::macro() const { return macro_; }
