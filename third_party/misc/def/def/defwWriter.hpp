...
extern int defwInit(FILE* f, int vers1, int version2, const char* caseSensitive, /* NAMESCASESENSITIVE */
...
extern int defwIntPropDef(const char* objType,                    // LIBRARY | LAYER | VIA | VIARULE |
 ...
 * Returns 0 if successfull.
 * The objType can be LIBRARY or VIA or MACRO or PIN. */
extern int defwRealPropDef(const char* objType,                    // LIBRARY | LAYER | VIA | VIARULE |
                                                                   // NONDEFAULTRULE | MACRO | PIN
                           const char* propName, double leftRange, /* optional(0) - RANGE */
                           double rightRange,                      /* optional(0) */
 ...
 * Returns 0 if successfull.
 * The objType can be LIBRARY or VIA or MACRO or PIN. */
extern int defwStringPropDef(const char* objType,                    // LIBRARY | LAYER | VIA | VIARULE |
                                                                     // NONDEFAULTRULE | MACRO | PIN
                             const char* propName, double leftRange, /* optional(0) - RANGE */
                             double      rightRange,                 /* optional(0) */
...
extern int defwRow(const char* rowName, const char* rowType, int x_orig, int y_orig, int orient, int do_count, /* optional (0) */
...
extern int defwRowStr(const char* rowName, const char* rowType, int x_orig, int y_orig, const char* orient,
...
extern int defwCanPlace(const char* master,               /* sitename */
                        int xOrig, int yOrig, int orient, /* 0 to 7 */
                        int doCnt,                        /* numX */
                        int doInc,                        /* numY */
                        int xStep,                        /* spaceX */
                        int yStep);                       /* spaceY */
...
extern int defwCanPlaceStr(const char* master,                       /* sitename */
                           int xOrig, int yOrig, const char* orient, /* 0 to 7 */
                           int doCnt,                                /* numX */
                           int doInc,                                /* numY */
                           int xStep,                                /* spaceX */
                           int yStep);                               /* spaceY */
...
/* This routine can be called multiple times. */
/* mask is 5.8 syntax */
extern int defwViaRect(const char* layerName, int xl, /* xl from the RECT */
 ...
 * This routine can be called multiple times. */
/* mask is 5.8 syntax */
extern int defwViaPolygon(const char* layerName, int num_polys, double* xl, double* yl, int mask = 0);
...
extern int defwViaViarule(const char* viaRuleName, double xCutSize, double yCutSize, const char* botMetalLayer,
...
extern int defwPinLayer(const char* layerName, int spacing, /* optional(0) - SPACING & DESIGNRULEWIDTH */
                        int designRuleWidth,                /* are mutually exclusive */
                        int xl, int yl, int xh, int yh, int mask = 0);
...
extern int defwPinPolygon(const char* layerName, int spacing, /* optional(0) - SPACING & DESIGNRULEWIDTH */
                          int designRuleWidth,                /* are mutually exclusive */
                          int num_polys, double* xl, double* yl, int mask = 0);
 ...
 * Returns 0 if successful.
 * This routine can be called multiple times within a pin. */
extern int defwPinPortLayer(const char* layerName, int spacing, /* optional(0) - SPACING & DESIGNRULEWIDTH */
                            int designRuleWidth,                /* are mutually exclusive */
                            int xl, int yl, int xh, int yh, int mask = 0);
 ...
 * Returns 0 if successful.
 * The routine can be called multiple times within a pin. */
extern int defwPinPortPolygon(const char* layerName, int spacing, /* optional(0) - SPACING & DESIGNRULEWIDTH */
                              int designRuleWidth,                /* are mutually exclusive */
                              int num_polys, double* xl, double* yl, int mask = 0);
...
extern int defwPinAntennaPinPartialMetalArea(int value, const char* layerName); /* optional(NULL) */

/* This routine must be called after defwPin.
 * Returns 0 if successful.
 * This is a 5.4 syntax.
 * The routine can be called multiple times. */
extern int defwPinAntennaPinPartialMetalSideArea(int value, const char* layerName); /* optional(NULL) */

/* This routine must be called after defwPin.
 * Returns 0 if successful.
 * This is a 5.4 syntax.
 * The routine can be called multiple times. */
extern int defwPinAntennaPinPartialCutArea(int value, const char* layerName); /* optional(NULL) */

/* This routine must be called after defwPin.
 * Returns 0 if successful.
 * This is a 5.4 syntax.
 * The routine can be called multiple times. */
extern int defwPinAntennaPinDiffArea(int value, const char* layerName); /* optional(NULL) */
 ...
 * This is a 5.4 syntax.
 * The routine can be called multiple times. */
extern int defwPinAntennaPinGateArea(int value, const char* layerName); /* optional(NULL) */

/* This routine must be called after defwPin.
 * Returns 0 if successful.
 * This is a 5.4 syntax.
 * The routine can be called multiple times. */
extern int defwPinAntennaPinMaxAreaCar(int value, const char* layerName); /* optional(NULL) */

/* This routine must be called after defwPin.
 * Returns 0 if successful.
 * This is a 5.4 syntax.
 * The routine can be called multiple times. */
extern int defwPinAntennaPinMaxSideAreaCar(int value, const char* layerName); /* optional(NULL) */

/* This routine must be called after defwPin.
 * Returns 0 if successful.
 * This is a 5.4 syntax.
 * The routine can be called multiple times. */
extern int defwPinAntennaPinMaxCutCar(int value, const char* layerName); /* optional(NULL) */
...
/* x and y location of the path */
extern int defwSpecialNetPathPointWithWireExt(int     numPts,    /* number of connected points */
                                              double* pointx,    /* point x list */
                                              double* pointy,    /* point y list */
...
extern int defwNetVpin(const char* vpinName, const char* layerName, /* optional(NULL) */
...
extern int defwNetVpinStr(const char* vpinName, const char* layerName, /* optional(NULL) */
                          int layerXl, int layerYl,                    /* layer point1 */
                          int layerXh, int layerYh,                    /* layer point2 */
                          const char* status,                          /* optional(NULL) */
                          int statusX, int statusY,                    /* optional(0) - status point */
...
extern int defwNetPathViaWithOrient(const char* name, int orient); /* optional(-1) */

extern int defwNetPathViaWithOrientStr(const char* name, const char* orient); /* optional(Null) */
...
extern int defwScanchainCommonscanpins(const char* inst1, /* optional(NULL) - IN | OUT*/
...
extern int defwScanchainPartition(const char* name, int maxBits); /* optional(-1) */
...
extern int defwScanchainOrdered(const char* name1, const char* inst1, /* optional(NULL) - IN | OUT */
                                const char* pin1,                     /* can't be null if inst1 is set */
                                const char* inst2,                    /* optional(NULL) - IN | OUT */
                                const char* pin2,                     /* can't be null if inst2 is set */
                                const char* name2, const char* inst3, /* optional(NULL) - IN | OUT */
 ...
 * the option BITS */
extern int defwScanchainOrderedBits(const char* name1, const char* inst1, /* optional(NULL) - IN | OUT */
                                    const char* pin1,                     /* can't be null if inst1 is set */
                                    const char* inst2,                    /* optional(NULL) - IN | OUT */
                                    const char* pin2,                     /* can't be null if inst2 is set */
...
extern int defwConstraintOperandPath(const char* comp1,   /* PATH - comp|PIN */
                                     const char* fromPin, const char* comp2, const char* toPin);
...
extern int defwGroupSoft(const char* type1, /* MAXHALFPERIMETER | MAXX | MAXY */
                         double value1, const char* type2, double value2, const char* type3, double value3);
 ...
 * This is a 5.4 syntax. */
extern int defwBlockageLayer(const char* layerName, const char* compName); /* optional(NULL) */
 ...
 * This is a 5.6 syntax.
 * Returns 0 if successful. */
extern int defwNonDefaultRule(const char* ruleName, int hardSpacing); /* optional(0) */
 ...
 * This is a 5.6 syntax.
 * Returns 0 if successful. */
extern int defwNonDefaultRuleLayer(const char* layerName, int width, int diagWidth, /* optional(0) */
