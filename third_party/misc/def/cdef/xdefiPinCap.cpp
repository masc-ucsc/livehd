...
int defiPinCap_pin(const ::defiPinCap* obj) { return ((LefDefParser::defiPinCap*)obj)->pin(); }

double defiPinCap_cap(const ::defiPinCap* obj) { return ((LefDefParser::defiPinCap*)obj)->cap(); }

void defiPinCap_print(const ::defiPinCap* obj, FILE* f) { ((LefDefParser::defiPinCap*)obj)->print(f); }
...
int defiPinPort_numLayer(const ::defiPinPort* obj) { return ((LefDefParser::defiPinPort*)obj)->numLayer(); }

const char* defiPinPort_layer(const ::defiPinPort* obj, int index) { return ((const LefDefParser::defiPinPort*)obj)->layer(index); }
...
int defiPinPort_layerSpacing(const ::defiPinPort* obj, int index) { return ((LefDefParser::defiPinPort*)obj)->layerSpacing(index); }

int defiPinPort_layerMask(const ::defiPinPort* obj, int index) { return ((LefDefParser::defiPinPort*)obj)->layerMask(index); }
...
int defiPinPort_numPolygons(const ::defiPinPort* obj) { return ((LefDefParser::defiPinPort*)obj)->numPolygons(); }
...
int defiPinPort_polygonMask(const ::defiPinPort* obj, int index) { return ((LefDefParser::defiPinPort*)obj)->polygonMask(index); }

int defiPinPort_numVias(const ::defiPinPort* obj) { return ((LefDefParser::defiPinPort*)obj)->numVias(); }

const char* defiPinPort_viaName(const ::defiPinPort* obj, int index) {
  return ((const LefDefParser::defiPinPort*)obj)->viaName(index);
}

int defiPinPort_viaPtX(const ::defiPinPort* obj, int index) { return ((LefDefParser::defiPinPort*)obj)->viaPtX(index); }

int defiPinPort_viaPtY(const ::defiPinPort* obj, int index) { return ((LefDefParser::defiPinPort*)obj)->viaPtY(index); }

int defiPinPort_viaTopMask(const ::defiPinPort* obj, int index) { return ((LefDefParser::defiPinPort*)obj)->viaTopMask(index); }

int defiPinPort_viaCutMask(const ::defiPinPort* obj, int index) { return ((LefDefParser::defiPinPort*)obj)->viaCutMask(index); }

int defiPinPort_viaBottomMask(const ::defiPinPort* obj, int index) {
  return ((LefDefParser::defiPinPort*)obj)->viaBottomMask(index);
}

int defiPinPort_hasPlacement(const ::defiPinPort* obj) { return ((LefDefParser::defiPinPort*)obj)->hasPlacement(); }

int defiPinPort_isPlaced(const ::defiPinPort* obj) { return ((LefDefParser::defiPinPort*)obj)->isPlaced(); }

int defiPinPort_isCover(const ::defiPinPort* obj) { return ((LefDefParser::defiPinPort*)obj)->isCover(); }

int defiPinPort_isFixed(const ::defiPinPort* obj) { return ((LefDefParser::defiPinPort*)obj)->isFixed(); }

int defiPinPort_placementX(const ::defiPinPort* obj) { return ((LefDefParser::defiPinPort*)obj)->placementX(); }

int defiPinPort_placementY(const ::defiPinPort* obj) { return ((LefDefParser::defiPinPort*)obj)->placementY(); }

int defiPinPort_orient(const ::defiPinPort* obj) { return ((LefDefParser::defiPinPort*)obj)->orient(); }

const char* defiPinPort_orientStr(const ::defiPinPort* obj) { return ((const LefDefParser::defiPinPort*)obj)->orientStr(); }

const char* defiPin_pinName(const ::defiPin* obj) { return ((const LefDefParser::defiPin*)obj)->pinName(); }

const char* defiPin_netName(const ::defiPin* obj) { return ((const LefDefParser::defiPin*)obj)->netName(); }

int defiPin_hasDirection(const ::defiPin* obj) { return ((LefDefParser::defiPin*)obj)->hasDirection(); }

int defiPin_hasUse(const ::defiPin* obj) { return ((LefDefParser::defiPin*)obj)->hasUse(); }

int defiPin_hasLayer(const ::defiPin* obj) { return ((LefDefParser::defiPin*)obj)->hasLayer(); }

int defiPin_hasPlacement(const ::defiPin* obj) { return ((LefDefParser::defiPin*)obj)->hasPlacement(); }

int defiPin_isUnplaced(const ::defiPin* obj) { return ((LefDefParser::defiPin*)obj)->isUnplaced(); }

int defiPin_isPlaced(const ::defiPin* obj) { return ((LefDefParser::defiPin*)obj)->isPlaced(); }

int defiPin_isCover(const ::defiPin* obj) { return ((LefDefParser::defiPin*)obj)->isCover(); }

int defiPin_isFixed(const ::defiPin* obj) { return ((LefDefParser::defiPin*)obj)->isFixed(); }

int defiPin_placementX(const ::defiPin* obj) { return ((LefDefParser::defiPin*)obj)->placementX(); }

int defiPin_placementY(const ::defiPin* obj) { return ((LefDefParser::defiPin*)obj)->placementY(); }

const char* defiPin_direction(const ::defiPin* obj) { return ((const LefDefParser::defiPin*)obj)->direction(); }

const char* defiPin_use(const ::defiPin* obj) { return ((const LefDefParser::defiPin*)obj)->use(); }

int defiPin_numLayer(const ::defiPin* obj) { return ((LefDefParser::defiPin*)obj)->numLayer(); }

const char* defiPin_layer(const ::defiPin* obj, int index) { return ((const LefDefParser::defiPin*)obj)->layer(index); }
...
int defiPin_layerMask(const ::defiPin* obj, int index) { return ((LefDefParser::defiPin*)obj)->layerMask(index); }

int defiPin_hasLayerSpacing(const ::defiPin* obj, int index) { return ((LefDefParser::defiPin*)obj)->hasLayerSpacing(index); }
...
int defiPin_layerSpacing(const ::defiPin* obj, int index) { return ((LefDefParser::defiPin*)obj)->layerSpacing(index); }

int defiPin_layerDesignRuleWidth(const ::defiPin* obj, int index) {
  return ((LefDefParser::defiPin*)obj)->layerDesignRuleWidth(index);
}

int defiPin_numPolygons(const ::defiPin* obj) { return ((LefDefParser::defiPin*)obj)->numPolygons(); }

const char* defiPin_polygonName(const ::defiPin* obj, int index) { return ((const LefDefParser::defiPin*)obj)->polygonName(index); }
...
int defiPin_polygonMask(const ::defiPin* obj, int index) { return ((LefDefParser::defiPin*)obj)->polygonMask(index); }

int defiPin_hasPolygonSpacing(const ::defiPin* obj, int index) { return ((LefDefParser::defiPin*)obj)->hasPolygonSpacing(index); }
...
int defiPin_polygonSpacing(const ::defiPin* obj, int index) { return ((LefDefParser::defiPin*)obj)->polygonSpacing(index); }
...
int defiPin_hasNetExpr(const ::defiPin* obj) { return ((LefDefParser::defiPin*)obj)->hasNetExpr(); }

int defiPin_hasSupplySensitivity(const ::defiPin* obj) { return ((LefDefParser::defiPin*)obj)->hasSupplySensitivity(); }

int defiPin_hasGroundSensitivity(const ::defiPin* obj) { return ((LefDefParser::defiPin*)obj)->hasGroundSensitivity(); }

const char* defiPin_netExpr(const ::defiPin* obj) { return ((const LefDefParser::defiPin*)obj)->netExpr(); }

const char* defiPin_supplySensitivity(const ::defiPin* obj) { return ((const LefDefParser::defiPin*)obj)->supplySensitivity(); }

const char* defiPin_groundSensitivity(const ::defiPin* obj) { return ((const LefDefParser::defiPin*)obj)->groundSensitivity(); }

int defiPin_orient(const ::defiPin* obj) { return ((LefDefParser::defiPin*)obj)->orient(); }

const char* defiPin_orientStr(const ::defiPin* obj) { return ((const LefDefParser::defiPin*)obj)->orientStr(); }

int defiPin_hasSpecial(const ::defiPin* obj) { return ((LefDefParser::defiPin*)obj)->hasSpecial(); }

int defiPin_numVias(const ::defiPin* obj) { return ((LefDefParser::defiPin*)obj)->numVias(); }

const char* defiPin_viaName(const ::defiPin* obj, int index) { return ((const LefDefParser::defiPin*)obj)->viaName(index); }

int defiPin_viaTopMask(const ::defiPin* obj, int index) { return ((LefDefParser::defiPin*)obj)->viaTopMask(index); }

int defiPin_viaCutMask(const ::defiPin* obj, int index) { return ((LefDefParser::defiPin*)obj)->viaCutMask(index); }

int defiPin_viaBottomMask(const ::defiPin* obj, int index) { return ((LefDefParser::defiPin*)obj)->viaBottomMask(index); }

int defiPin_viaPtX(const ::defiPin* obj, int index) { return ((LefDefParser::defiPin*)obj)->viaPtX(index); }

int defiPin_viaPtY(const ::defiPin* obj, int index) { return ((LefDefParser::defiPin*)obj)->viaPtY(index); }

int defiPin_hasAPinPartialMetalArea(const ::defiPin* obj) { return ((LefDefParser::defiPin*)obj)->hasAPinPartialMetalArea(); }

int defiPin_numAPinPartialMetalArea(const ::defiPin* obj) { return ((LefDefParser::defiPin*)obj)->numAPinPartialMetalArea(); }
...
int defiPin_hasAPinDiffArea(const ::defiPin* obj) { return ((LefDefParser::defiPin*)obj)->hasAPinDiffArea(); }

int defiPin_numAPinDiffArea(const ::defiPin* obj) { return ((LefDefParser::defiPin*)obj)->numAPinDiffArea(); }

int defiPin_APinDiffArea(const ::defiPin* obj, int index) { return ((LefDefParser::defiPin*)obj)->APinDiffArea(index); }
...
int defiPin_hasAPinPartialCutArea(const ::defiPin* obj) { return ((LefDefParser::defiPin*)obj)->hasAPinPartialCutArea(); }

int defiPin_numAPinPartialCutArea(const ::defiPin* obj) { return ((LefDefParser::defiPin*)obj)->numAPinPartialCutArea(); }

int defiPin_APinPartialCutArea(const ::defiPin* obj, int index) { return ((LefDefParser::defiPin*)obj)->APinPartialCutArea(index); }
...
int defiPin_numAntennaModel(const ::defiPin* obj) { return ((LefDefParser::defiPin*)obj)->numAntennaModel(); }
...
int defiPin_hasPort(const ::defiPin* obj) { return ((LefDefParser::defiPin*)obj)->hasPort(); }

int defiPin_numPorts(const ::defiPin* obj) { return ((LefDefParser::defiPin*)obj)->numPorts(); }
...
void defiPin_print(const ::defiPin* obj, FILE* f) { ((LefDefParser::defiPin*)obj)->print(f); }
