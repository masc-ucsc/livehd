...
int defiTimingDisable_hasThru(const ::defiTimingDisable* obj) { return ((LefDefParser::defiTimingDisable*)obj)->hasThru(); }

int defiTimingDisable_hasFromTo(const ::defiTimingDisable* obj) { return ((LefDefParser::defiTimingDisable*)obj)->hasFromTo(); }
...
void defiTimingDisable_print(const ::defiTimingDisable* obj, FILE* f) { ((LefDefParser::defiTimingDisable*)obj)->print(f); }
