...
const char* defiNonDefault_name(const ::defiNonDefault* obj) { return ((const LefDefParser::defiNonDefault*)obj)->name(); }

int defiNonDefault_hasHardspacing(const ::defiNonDefault* obj) { return ((LefDefParser::defiNonDefault*)obj)->hasHardspacing(); }

int defiNonDefault_numProps(const ::defiNonDefault* obj) { return ((LefDefParser::defiNonDefault*)obj)->numProps(); }
...
int defiNonDefault_numLayers(const ::defiNonDefault* obj) { return ((LefDefParser::defiNonDefault*)obj)->numLayers(); }
...
int defiNonDefault_numVias(const ::defiNonDefault* obj) { return ((LefDefParser::defiNonDefault*)obj)->numVias(); }
...
int defiNonDefault_numViaRules(const ::defiNonDefault* obj) { return ((LefDefParser::defiNonDefault*)obj)->numViaRules(); }
...
int defiNonDefault_numMinCuts(const ::defiNonDefault* obj) { return ((LefDefParser::defiNonDefault*)obj)->numMinCuts(); }
...
int defiNonDefault_numCuts(const ::defiNonDefault* obj, int index) { return ((LefDefParser::defiNonDefault*)obj)->numCuts(index); }

void defiNonDefault_print(const ::defiNonDefault* obj, FILE* f) { ((LefDefParser::defiNonDefault*)obj)->print(f); }
