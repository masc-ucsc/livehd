...
int defiGeometries_numPoints(const ::defiGeometries* obj) { return ((LefDefParser::defiGeometries*)obj)->numPoints(); }
...
int defiStyles_style(const ::defiStyles* obj) { return ((LefDefParser::defiStyles*)obj)->style(); }
