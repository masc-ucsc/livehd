...
public:
  ...
  void addTwoWidths(double width, double runLength, int numSpacing, double* spacings, int hasPRL = 0);
...
public:
  ...
  void setInfluence();
  void addInfluence(double width, double distance, double spacing);
  void addTwoWidths(double width, double runLength, int numSpacing, double* spacing, int hasPRL = 0);  // 5.7
...
public:
  ...
  void setSpacingEndOfNotchWidth(double endOfNotchWidth, double minNotchSpacing, double minNotchLength);  // 5.7
  ...
  void addNumProp(const char* name, const double d, const char* value, const char type);
  ...
  void        currentDensityArray(int* numPoints, double** widths, double** current) const;
  void        capacitanceArray(int* numPoints, double** widths, double** resValues) const;
  void        resistanceArray(int* numPoints, double** widths, double** capValues) const;
