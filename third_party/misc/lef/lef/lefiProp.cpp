...
void lefiProp::setPropInteger() { dataType_ = 'I'; }

void lefiProp::setPropReal() { dataType_ = 'R'; }
...
int lefiProp::hasRange() const { return (int)(hasRange_); }

double lefiProp::number() const { return d_; }

double lefiProp::left() const { return left_; }

double lefiProp::right() const { return right_; }
...
int lefiProp::hasString() const { return *(stringData_) ? 1 : 0; }
