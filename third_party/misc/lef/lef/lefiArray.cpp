...
int lefiArray::numSitePattern() const { return numPatterns_; }

int lefiArray::numCanPlace() const { return numCan_; }

int lefiArray::numCannotOccupy() const { return numCannot_; }

int lefiArray::numTrack() const { return numTracks_; }

int lefiArray::numGcell() const { return numG_; }
...
int lefiArray::numDefaultCaps() const { return numDefault_; }

int lefiArray::defaultCapMinPins(int index) const { return minPins_[index]; }

double lefiArray::defaultCap(int index) const { return caps_[index]; }
