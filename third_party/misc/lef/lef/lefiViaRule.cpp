...
void lefiViaRuleLayer::setHorizontal() { direction_ = 'H'; }

void lefiViaRuleLayer::setVertical() { direction_ = 'V'; }
...
int lefiViaRuleLayer::hasRect() const { return hasRect_; }

int lefiViaRuleLayer::hasDirection() const { return direction_ ? 1 : 0; }

// 5.5
int lefiViaRuleLayer::hasEnclosure() const { return overhang1_ == -1 ? 0 : 1; }

int lefiViaRuleLayer::hasWidth() const { return hasWidth_; }

int lefiViaRuleLayer::hasResistance() const { return hasResistance_; }

int lefiViaRuleLayer::hasOverhang() const { return hasOverhang_; }

int lefiViaRuleLayer::hasMetalOverhang() const { return hasMetalOverhang_; }
...
int lefiViaRuleLayer::isVertical() const { return direction_ == 'V' ? 1 : 0; }

// 5.5
double lefiViaRuleLayer::enclosureOverhang1() const { return overhang1_; }

// 5.5
double lefiViaRuleLayer::enclosureOverhang2() const { return overhang2_; }

double lefiViaRuleLayer::widthMin() const { return widthMin_; }

double lefiViaRuleLayer::widthMax() const { return widthMax_; }

double lefiViaRuleLayer::overhang() const { return overhang_; }

double lefiViaRuleLayer::metalOverhang() const { return metalOverhang_; }

double lefiViaRuleLayer::resistance() const { return resistance_; }

double lefiViaRuleLayer::spacingStepX() const { return spacingStepX_; }

double lefiViaRuleLayer::spacingStepY() const { return spacingStepY_; }

double lefiViaRuleLayer::xl() const { return xl_; }

double lefiViaRuleLayer::yl() const { return yl_; }

double lefiViaRuleLayer::xh() const { return xh_; }
...
lefiViaRule::~lefiViaRule() { Destroy(); }

void lefiViaRule::setGenerate() { hasGenerate_ = 1; }
...
void lefiViaRule::setRect(double xl, double yl, double xh, double yh) { layers_[numLayers_ - 1].setRect(xl, yl, xh, yh); }

void lefiViaRule::setSpacing(double x, double y) { layers_[numLayers_ - 1].setSpacing(x, y); }

void lefiViaRule::setWidth(double x, double y) { layers_[numLayers_ - 1].setWidth(x, y); }

void lefiViaRule::setResistance(double d) { layers_[numLayers_ - 1].setResistance(d); }

void lefiViaRule::setOverhang(double d) { layers_[numLayers_ - 1].setOverhang(d); }
...
void lefiViaRule::setMetalOverhang(double d) { layers_[numLayers_ - 1].setMetalOverhang(d); }

void lefiViaRule::setVertical() { layers_[numLayers_ - 1].setVertical(); }

void lefiViaRule::setHorizontal() { layers_[numLayers_ - 1].setHorizontal(); }
...
int lefiViaRule::hasGenerate() const { return hasGenerate_; }

int lefiViaRule::hasDefault() const { return hasDefault_; }
