...
void lefiAntennaPWL::clear() { numPWL_ = 0; }
...
int lefiLayerDensity::numFrequency() const { return numFrequency_; }

double lefiLayerDensity::frequency(int index) const { return frequency_[index]; }

int lefiLayerDensity::numWidths() const { return numWidths_; }

double lefiLayerDensity::width(int index) const { return widths_[index]; }

int lefiLayerDensity::numTableEntries() const { return numTableEntries_; }

double lefiLayerDensity::tableEntry(int index) const { return tableEntries_[index]; }

int lefiLayerDensity::numCutareas() const { return numCutareas_; }

double lefiLayerDensity::cutArea(int index) const { return cutareas_[index]; }

// *****************************************************************************
// lefiParallel
// *****************************************************************************

lefiParallel::lefiParallel() { Init(); }
...
int lefiParallel::numWidth() const { return numWidth_; }

double lefiParallel::length(int index) const { return length_[index]; }

double lefiParallel::width(int index) const { return width_[index]; }
...
lefiInfluence::lefiInfluence() { Init(); }
...
lefiInfluence::~lefiInfluence() { Destroy(); }
...
int lefiInfluence::numInfluenceEntry() const { return numWidth_; }

double lefiInfluence::width(int index) const { return width_[index]; }

double lefiInfluence::distance(int index) const { return distance_[index]; }

double lefiInfluence::spacing(int index) const { return spacing_[index]; }

// *****************************************************************************
// lefiTwoWidths
// *****************************************************************************

lefiTwoWidths::lefiTwoWidths() { Init(); }
...
int lefiTwoWidths::numWidth() const { return numWidth_; }
...
double lefiTwoWidths::widthPRL(int index) const { return prl_[index]; }
...
lefiSpacingTable::lefiSpacingTable() { Init(); }
...
int lefiSpacingTable::isInfluence() const { return hasInfluence_ ? 1 : 0; }
...
lefiOrthogonal::lefiOrthogonal() { Init(); }
...
lefiAntennaModel::lefiAntennaModel() { Init(); }
...
lefiAntennaModel::~lefiAntennaModel() { Destroy(); }
...
void lefiAntennaModel::setAntennaModel(int aOxide) {
  ...
  switch (aOxide) {
    ...
    case 4: oxide_ = strdup("OXIDE4"); break;
    default: oxide_ = strdup("OXIDE1"); break;
  }
}
...
void lefiAntennaModel::setAntennaDUO(lefiAntennaEnum antennaType) {
  switch (antennaType) {
    case lefiAntennaAF: hasAntennaAreaFactorDUO_ = 1; break;
    case lefiAntennaSAF: hasAntennaSideAreaFactorDUO_ = 1; break;
    default: break;
  }
}
...
// 5.7
void lefiAntennaModel::setAntennaCumRoutingPlusCut() { hasAntennaCumRoutingPlusCut_ = 1; }
...
int lefiAntennaModel::hasAntennaAreaRatio() const { return hasAntennaAreaRatio_; }

int lefiAntennaModel::hasAntennaDiffAreaRatio() const { return hasAntennaDiffAreaRatio_; }

int lefiAntennaModel::hasAntennaCumAreaRatio() const { return hasAntennaCumAreaRatio_; }

int lefiAntennaModel::hasAntennaCumDiffAreaRatio() const { return hasAntennaCumDiffAreaRatio_; }

int lefiAntennaModel::hasAntennaAreaFactor() const { return hasAntennaAreaFactor_; }

int lefiAntennaModel::hasAntennaSideAreaRatio() const { return hasAntennaSideAreaRatio_; }

int lefiAntennaModel::hasAntennaDiffSideAreaRatio() const { return hasAntennaDiffSideAreaRatio_; }

int lefiAntennaModel::hasAntennaCumSideAreaRatio() const { return hasAntennaCumSideAreaRatio_; }

int lefiAntennaModel::hasAntennaCumDiffSideAreaRatio() const { return hasAntennaCumDiffSideAreaRatio_; }

int lefiAntennaModel::hasAntennaSideAreaFactor() const { return hasAntennaSideAreaFactor_; }

int lefiAntennaModel::hasAntennaDiffAreaRatioPWL() const { return antennaDiffAreaRatioPWL_ ? 1 : 0; }

int lefiAntennaModel::hasAntennaCumDiffAreaRatioPWL() const { return antennaCumDiffAreaRatioPWL_ ? 1 : 0; }

int lefiAntennaModel::hasAntennaDiffSideAreaRatioPWL() const { return antennaDiffSideAreaRatioPWL_ ? 1 : 0; }

int lefiAntennaModel::hasAntennaCumDiffSideAreaRatioPWL() const { return antennaCumDiffSideAreaRatioPWL_ ? 1 : 0; }

int lefiAntennaModel::hasAntennaAreaFactorDUO() const { return hasAntennaAreaFactorDUO_; }

int lefiAntennaModel::hasAntennaSideAreaFactorDUO() const { return hasAntennaSideAreaFactorDUO_; }

// 5.7
int lefiAntennaModel::hasAntennaCumRoutingPlusCut() const { return hasAntennaCumRoutingPlusCut_; }

// 5.7
int lefiAntennaModel::hasAntennaGatePlusDiff() const { return hasAntennaGatePlusDiff_; }

// 5.7
int lefiAntennaModel::hasAntennaAreaMinusDiff() const { return hasAntennaAreaMinusDiff_; }
...
double lefiAntennaModel::antennaDiffAreaRatio() const { return antennaDiffAreaRatio_; }

double lefiAntennaModel::antennaCumAreaRatio() const { return antennaCumAreaRatio_; }

double lefiAntennaModel::antennaCumDiffAreaRatio() const { return antennaCumDiffAreaRatio_; }

double lefiAntennaModel::antennaAreaFactor() const { return antennaAreaFactor_; }

double lefiAntennaModel::antennaSideAreaRatio() const { return antennaSideAreaRatio_; }

double lefiAntennaModel::antennaDiffSideAreaRatio() const { return antennaDiffSideAreaRatio_; }

double lefiAntennaModel::antennaCumSideAreaRatio() const { return antennaCumSideAreaRatio_; }

double lefiAntennaModel::antennaCumDiffSideAreaRatio() const { return antennaCumDiffSideAreaRatio_; }
...
// 5.5
void lefiLayer::setMaxwidth(double width) { maxwidth_ = width; }

// 5.5
void lefiLayer::setMinwidth(double width) { minwidth_ = width; }
...
// 5.5
void lefiLayer::addMinenclosedareaWidth(double width) { minenclosedareaWidth_[numMinenclosedarea_ - 1] = width; }
...
// 5.7
void lefiLayer::addMinstepMaxedges(int maxEdges) { minstepMaxEdges_[numMinstep_ - 1] = maxEdges; }

// 5.7
void lefiLayer::addMinstepMinAdjLength(double adjLength) { minstepMinAdjLength_[numMinstep_ - 1] = adjLength; }

// 5.7
void lefiLayer::addMinstepMinBetLength(double betLength) { minstepMinBetLength_[numMinstep_ - 1] = betLength; }

// 5.7
void lefiLayer::addMinstepXSameCorners() { minstepXSameCorners_[numMinstep_ - 1] = 1; }
...
void lefiLayer::setSpacingLayerStack() { hasSpacingLayerStack_[numSpacings_ - 1] = 1; }
...
void lefiLayer::setSpacingRangeUseLength() { hasSpacingUseLengthThreshold_[numSpacings_ - 1] = 1; }

void lefiLayer::setSpacingRangeInfluence(double infLength) { rangeInfluence_[numSpacings_ - 1] = infLength; }
...
void lefiLayer::setSpacingCenterToCenter() { hasSpacingCenterToCenter_[numSpacings_ - 1] = 1; }

// 5.7
void lefiLayer::setSpacingParallelOverlap() { hasSpacingParallelOverlap_[numSpacings_ - 1] = 1; }
...
// 5.7
void lefiLayer::setSpacingParTwoEdges() { hasSpacingTwoEdges_[numSpacings_ - 1] = 1; }

// 5.7
void lefiLayer::setSpacingAdjacentExcept() { hasSpacingAdjacentExcept_[numSpacings_ - 1] = 1; }

// 5.7
void lefiLayer::setSpacingSamenet() { hasSpacingSamenet_[numSpacings_ - 1] = 1; }

// 5.7
void lefiLayer::setSpacingSamenetPGonly() { hasSpacingSamenetPGonly_[numSpacings_ - 1] = 1; }

// 5.7
void lefiLayer::setSpacingNotchLength(double notchLength) { notchLength_[numSpacings_ - 1] = notchLength; }

// 5.7
void lefiLayer::setSpacingEndOfNotchWidth(double eonWidth, double mnSpacing, double eonLength) {
...
// 5.7
void lefiLayer::setMaxFloatingArea(double num) { maxArea_ = num; }

// 5.7
void lefiLayer::setArraySpacingLongArray() { hasLongArray_ = 1; }

// 5.7
void lefiLayer::setArraySpacingWidth(double viaWidth) { viaWidth_ = viaWidth; }

// 5.7
void lefiLayer::setArraySpacingCut(double cutSpacing) { cutSpacing_ = cutSpacing; }
...
int lefiLayer::hasType() const { return (type_[0] != '\0') ? 1 : 0; }
...
int lefiLayer::hasArea() const { return hasArea_; }
...
// 5.6
int lefiLayer::hasDiagWidth() const { return hasDiagWidth_; }

// 5.6
int lefiLayer::hasDiagSpacing() const { return hasDiagSpacing_; }

int lefiLayer::hasWireExtension() const { return hasWireExtension_; }

int lefiLayer::hasSpacingNumber() const { return ((hasSpacing_ != 0) && (numSpacings_ > 0)) ? 1 : 0; }

int lefiLayer::hasSpacingName(int index) const { return ((hasSpacing_ != 0) && (hasSpacingName_[index] != 0)) ? 1 : 0; }

int lefiLayer::hasSpacingLayerStack(int index) const { return ((hasSpacing_ != 0) && (hasSpacingLayerStack_[index] != 0)) ? 1 : 0; }

int lefiLayer::hasSpacingAdjacent(int index) const { return ((hasSpacing_ != 0) && (hasSpacingAdjacent_[index] != 0)) ? 1 : 0; }

int lefiLayer::hasSpacingRange(int index) const { return ((hasSpacing_ != 0) && (hasSpacingRange_[index] != 0)) ? 1 : 0; }

int lefiLayer::hasSpacingRangeUseLengthThreshold(int index) const { return (hasSpacingUseLengthThreshold_[index]); }

int lefiLayer::hasSpacingRangeInfluence(int index) const {
  return ((hasSpacing_ != 0) && (hasSpacingRange_[index] != 0) && (rangeInfluence_[index]) != -1) ? 1 : 0;
}

int lefiLayer::hasSpacingRangeInfluenceRange(int index) const {
  return ((hasSpacing_ != 0) && (hasSpacingRange_[index] != 0) && (rangeInfluenceRangeMin_[index] != -1)
...
int lefiLayer::hasSpacingRangeRange(int index) const {
  return ((hasSpacing_ != 0) && (hasSpacingRange_[index] != 0) && (rangeRangeMin_[index] != -1) && (rangeRangeMax_[index] != -1))
             ? 1
             : 0;
}

int lefiLayer::hasSpacingLengthThreshold(int index) const { return (hasSpacingLengthThreshold_[index]) ? 1 : 0; }

int lefiLayer::hasSpacingLengthThresholdRange(int index) const {
  return ((hasSpacing_ != 0) && (hasSpacingLengthThreshold_[index] != 0) && (lengthThresholdRangeMin_[index] != -1)
...
int lefiLayer::hasSpacingCenterToCenter(int index) const {
  return ((hasSpacing_ != 0) && (hasSpacingCenterToCenter_[index] != 0)) ? 1 : 0;
}

// 5.7
int lefiLayer::hasSpacingParallelOverlap(int index) const {
  return ((hasSpacing_ != 0) && (hasSpacingParallelOverlap_[index] != 0)) ? 1 : 0;
}

// 5.7
int lefiLayer::hasSpacingArea(int index) const { return ((hasSpacing_ != 0) && (hasSpacingCutArea_[index] != 0)) ? 1 : 0; }

// 5.7
int lefiLayer::hasSpacingEndOfLine(int index) const { return ((hasSpacing_ != 0) && (hasSpacingEndOfLine_[index] != 0)) ? 1 : 0; }
...
// 5.7
int lefiLayer::hasSpacingTwoEdges(int index) const { return ((hasSpacing_ != 0) && (hasSpacingTwoEdges_[index] != 0)) ? 1 : 0; }

// 5.7
int lefiLayer::hasSpacingAdjacentExcept(int index) const {
  return ((hasSpacing_ != 0) && (hasSpacingAdjacentExcept_[index] != 0)) ? 1 : 0;
}

// 5.7
int lefiLayer::hasSpacingSamenet(int index) const { return ((hasSpacing_ != 0) && (hasSpacingSamenet_[index] != 0)) ? 1 : 0; }
...
// 5.7
int lefiLayer::hasSpacingNotchLength(int index) const { return (notchLength_[index] >= 0) ? 1 : 0; }

// 5.7
int lefiLayer::hasSpacingEndOfNotchWidth(int index) const { return (endOfNotchWidth_[index] != 0) ? 1 : 0; }

// 5.7
int lefiLayer::hasSpacingTableOrtho() const { return hasSpacingTableOrtho_ ? 1 : 0; }

// 5.7
int lefiLayer::hasMaxFloatingArea() const { return maxArea_ ? 1 : 0; }

// 5.7
int lefiLayer::hasArraySpacing() const { return cutSpacing_ ? 1 : 0; }

// 5.7
int lefiLayer::hasLongArray() const { return hasLongArray_ ? 1 : 0; }

// 5.7
int lefiLayer::hasViaWidth() const { return viaWidth_ ? 1 : 0; }

int lefiLayer::hasDirection() const { return hasDirection_; }

int lefiLayer::hasResistance() const { return hasResistance_; }

int lefiLayer::hasCapacitance() const { return hasCapacitance_; }

int lefiLayer::hasHeight() const { return hasHeight_; }

int lefiLayer::hasThickness() const { return hasThickness_; }

int lefiLayer::hasShrinkage() const { return hasShrinkage_; }

int lefiLayer::hasCapMultiplier() const { return hasCapMultiplier_; }

int lefiLayer::hasEdgeCap() const { return hasEdgeCap_; }

int lefiLayer::hasAntennaArea() const { return hasAntennaArea_; }

int lefiLayer::hasAntennaLength() const { return hasAntennaLength_; }

int lefiLayer::hasCurrentDensityPoint() const { return hasCurrentDensityPoint_; }

int lefiLayer::hasCurrentDensityArray() const { return numCurrentPoints_ ? 1 : 0; }

int lefiLayer::hasResistanceArray() const { return numResistancePoints_ ? 1 : 0; }
...
// 5.6
double lefiLayer::pitchX() const { return pitchX_; }

// 5.6
double lefiLayer::pitchY() const { return pitchY_; }

double lefiLayer::offset() const { return offsetX_; }

// 5.6
double lefiLayer::offsetX() const { return offsetX_; }

// 5.6
double lefiLayer::offsetY() const { return offsetY_; }

double lefiLayer::width() const { return width_; }

double lefiLayer::area() const { return area_; }

// 5.6
double lefiLayer::diagPitch() const { return diagPitchX_; }

// 5.6
double lefiLayer::diagPitchX() const { return diagPitchX_; }

// 5.6
double lefiLayer::diagPitchY() const { return diagPitchY_; }

// 5.6
double lefiLayer::diagWidth() const { return diagWidth_; }

// 5.6
double lefiLayer::diagSpacing() const { return diagSpacing_; }

double lefiLayer::wireExtension() const { return wireExtension_; }
...
double lefiLayer::spacingAdjacentWithin(int index) const { return spacingAdjacentWithin_[index]; }

double lefiLayer::spacingArea(int index) const { return spacingCutArea_[index]; }

double lefiLayer::spacingRangeMin(int index) const { return rangeMin_[index]; }

double lefiLayer::spacingRangeMax(int index) const { return rangeMax_[index]; }

double lefiLayer::spacingRangeInfluence(int index) const { return rangeInfluence_[index]; }

double lefiLayer::spacingRangeInfluenceMin(int index) const { return rangeInfluenceRangeMin_[index]; }

double lefiLayer::spacingRangeInfluenceMax(int index) const { return rangeInfluenceRangeMax_[index]; }

double lefiLayer::spacingRangeRangeMin(int index) const { return rangeRangeMin_[index]; }

double lefiLayer::spacingRangeRangeMax(int index) const { return rangeRangeMax_[index]; }

double lefiLayer::spacingLengthThreshold(int index) const { return lengthThreshold_[index]; }

double lefiLayer::spacingLengthThresholdRangeMin(int index) const { return lengthThresholdRangeMin_[index]; }

double lefiLayer::spacingLengthThresholdRangeMax(int index) const { return lengthThresholdRangeMax_[index]; }

// 5.7
double lefiLayer::spacingEolWidth(int index) const { return eolWidth_[index]; }

// 5.7
double lefiLayer::spacingEolWithin(int index) const { return eolWithin_[index]; }

// 5.7
double lefiLayer::spacingParSpace(int index) const { return parSpace_[index]; }

// 5.7
double lefiLayer::spacingParWithin(int index) const { return parWithin_[index]; }

// 5.7
double lefiLayer::spacingNotchLength(int index) const { return notchLength_[index]; }

// 5.7
double lefiLayer::spacingEndOfNotchWidth(int index) const { return endOfNotchWidth_[index]; }

// 5.7
double lefiLayer::spacingEndOfNotchSpacing(int index) const { return minNotchSpacing_[index]; }
...
double lefiLayer::resistance() const { return resistance_; }

double lefiLayer::capacitance() const { return capacitance_; }

double lefiLayer::height() const { return height_; }

double lefiLayer::thickness() const { return thickness_; }

double lefiLayer::shrinkage() const { return shrinkage_; }

double lefiLayer::capMultiplier() const { return capMultiplier_; }

double lefiLayer::edgeCap() const { return edgeCap_; }

double lefiLayer::antennaLength() const { return antennaLength_; }

double lefiLayer::antennaArea() const { return antennaArea_; }

// 5.5
int lefiLayer::numMinimumcut() const { return numMinimumcut_; }

// 5.5
int lefiLayer::minimumcut(int index) const { return minimumcut_[index]; }

// 5.5
double lefiLayer::minimumcutWidth(int index) const { return minimumcutWidth_[index]; }

// 5.7
int lefiLayer::hasMinimumcutWithin(int index) const { return hasMinimumcutWithin_[index]; }

// 5.7
double lefiLayer::minimumcutWithin(int index) const { return minimumcutWithin_[index]; }
...
// 5.5
double lefiLayer::minimumcutLength(int index) const { return minimumcutLength_[index]; }

// 5.5
double lefiLayer::minimumcutDistance(int index) const { return minimumcutDistance_[index]; }

// 5.5
int lefiLayer::hasMaxwidth() const { return maxwidth_ == -1 ? 0 : 1; }

// 5.5
double lefiLayer::maxwidth() const { return maxwidth_; }

// 5.5
int lefiLayer::hasMinwidth() const { return minwidth_ == -1 ? 0 : 1; }

// 5.5
double lefiLayer::minwidth() const { return minwidth_; }

// 5.8
int lefiLayer::mask() const { return maskNumber_; }

// 5.5
int lefiLayer::numMinenclosedarea() const { return numMinenclosedarea_; }

// 5.5
int lefiLayer::hasMinenclosedareaWidth(int index) const { return minenclosedareaWidth_[index] == -1 ? 0 : 1; }

// 5.5
double lefiLayer::minenclosedarea(int index) const { return minenclosedarea_[index]; }

// 5.5
double lefiLayer::minenclosedareaWidth(int index) const { return minenclosedareaWidth_[index]; }

// 5.5 & 5.6
int lefiLayer::hasMinstep() const { return numMinstep_ ? 1 : 0; }

// 5.5
int lefiLayer::hasProtrusion() const { return protrusionWidth1_ == -1 ? 0 : 1; }

// 5.5
double lefiLayer::protrusionWidth1() const { return protrusionWidth1_; }

// 5.5
double lefiLayer::protrusionLength() const { return protrusionLength_; }
...
int lefiLayer::getNumber() { return numNums_ - 1; }

int lefiLayer::hasAccurrentDensity() const { return numAccurrents_ ? 1 : 0; }

int lefiLayer::hasDccurrentDensity() const { return numDccurrents_ ? 1 : 0; }

int lefiLayer::numAccurrentDensity() const { return (numAccurrents_); }
...
int lefiLayer::hasSlotWireWidth() const { return hasSlotWireWidth_; }

int lefiLayer::hasSlotWireLength() const { return hasSlotWireLength_; }

int lefiLayer::hasSlotWidth() const { return hasSlotWidth_; }

int lefiLayer::hasSlotLength() const { return hasSlotLength_; }

int lefiLayer::hasMaxAdjacentSlotSpacing() const { return hasMaxAdjacentSlotSpacing_; }

int lefiLayer::hasMaxCoaxialSlotSpacing() const { return hasMaxCoaxialSlotSpacing_; }

int lefiLayer::hasMaxEdgeSlotSpacing() const { return hasMaxEdgeSlotSpacing_; }

int lefiLayer::hasSplitWireWidth() const { return hasSplitWireWidth_; }

int lefiLayer::hasMinimumDensity() const { return hasMinimumDensity_; }

int lefiLayer::hasMaximumDensity() const { return hasMaximumDensity_; }

int lefiLayer::hasDensityCheckWindow() const { return hasDensityCheckWindow_; }

int lefiLayer::hasDensityCheckStep() const { return hasDensityCheckStep_; }

int lefiLayer::hasFillActiveSpacing() const { return hasFillActiveSpacing_; }

double lefiLayer::slotWireWidth() const { return slotWireWidth_; }

double lefiLayer::slotWireLength() const { return slotWireLength_; }

double lefiLayer::slotWidth() const { return slotWidth_; }

double lefiLayer::slotLength() const { return slotLength_; }

double lefiLayer::maxAdjacentSlotSpacing() const { return maxAdjacentSlotSpacing_; }

double lefiLayer::maxCoaxialSlotSpacing() const { return maxCoaxialSlotSpacing_; }

double lefiLayer::maxEdgeSlotSpacing() const { return maxEdgeSlotSpacing_; }

double lefiLayer::splitWireWidth() const { return splitWireWidth_; }

double lefiLayer::minimumDensity() const { return minimumDensity_; }

double lefiLayer::maximumDensity() const { return maximumDensity_; }

double lefiLayer::densityCheckWindowLength() const { return densityCheckWindowLength_; }

double lefiLayer::densityCheckWindowWidth() const { return densityCheckWindowWidth_; }

double lefiLayer::densityCheckStep() const { return densityCheckStep_; }

double lefiLayer::fillActiveSpacing() const { return fillActiveSpacing_; }
...
int lefiLayer::numSpacingTable() { return numSpacingTable_; }
...
void lefiLayer::addEnclosureWidth(double minWidth) { encminWidth_[numEnclosure_ - 1] = minWidth; }

void lefiLayer::addEnclosureExceptEC(double cutWithin) { cutWithin_[numEnclosure_ - 1] = cutWithin; }

void lefiLayer::addEnclosureLength(double minLength) { minLength_[numEnclosure_ - 1] = minLength; }

int lefiLayer::numEnclosure() const { return numEnclosure_; }
...
double lefiLayer::enclosureOverhang2(int index) const { return overhang2_[index]; }

int lefiLayer::hasEnclosureWidth(int index) const { return encminWidth_[index] ? 1 : 0; }

double lefiLayer::enclosureMinWidth(int index) const { return encminWidth_[index]; }

int lefiLayer::hasEnclosureExceptExtraCut(int index) const { return cutWithin_[index] ? 1 : 0; }

double lefiLayer::enclosureExceptExtraCut(int index) const { return cutWithin_[index]; }

int lefiLayer::hasEnclosureMinLength(int index) const { return minLength_[index] ? 1 : 0; }
...
void lefiLayer::addPreferEnclosureWidth(double minWidth) { preferMinWidth_[numPreferEnclosure_ - 1] = minWidth; }

int lefiLayer::numPreferEnclosure() const { return numPreferEnclosure_; }
...
double lefiLayer::preferEnclosureOverhang2(int index) const { return preferOverhang2_[index]; }

int lefiLayer::hasPreferEnclosureWidth(int index) const { return preferMinWidth_[index] ? 1 : 0; }

double lefiLayer::preferEnclosureMinWidth(int index) const { return preferMinWidth_[index]; }

void lefiLayer::setResPerCut(double value) { resPerCut_ = value; }

int lefiLayer::hasResistancePerCut() const { return resPerCut_ ? 1 : 0; }

double lefiLayer::resistancePerCut() const { return resPerCut_; }

void lefiLayer::setDiagMinEdgeLength(double value) { diagMinEdgeLength_ = value; }

int lefiLayer::hasDiagMinEdgeLength() const { return diagMinEdgeLength_ ? 1 : 0; }
...
int lefiLayer::numMinSize() const { return numMinSize_; }

double lefiLayer::minSizeWidth(int index) const {
  char msg[160];
  if (index < 0 || index > numMinSize_) {
    sprintf(msg,
            "ERROR (LEFPARS-1301): The index number %d given for the layer MINSIZE is invalid.\nValid index is from 0 to %d\n",
            index,
            numMinSize_);
...
int lefiLayer::numMinstep() const { return numMinstep_; }
...
// 5.7
double lefiLayer::viaWidth() const { return viaWidth_; }

// 5.7
double lefiLayer::cutSpacing() const { return cutSpacing_; }

// 5.7
int lefiLayer::numArrayCuts() const { return numArrayCuts_; }
...
void lefiLayer::parseSpacing(int index) {
  ...
  while (value) {
    ...
    value = strtok(NULL, " ");
    if ((strcmp(value, "CENTERTOCENTER") == 0) || (strcmp(value, "SAMENET") == 0) || (strcmp(value, "LAYER") == 0)
        || (strcmp(value, "ADJACENTCUTS") == 0) || (strcmp(value, "PARALLELOVERLAP") == 0) || (strcmp(value, "AREA") == 0)) {
      if (strcmp(type(), "CUT") != 0) {
        /*
                    sprintf(msg, "ERROR (LEFPARS-1321): The property LEF57_SPACING with value %s is for TYPE CUT only.\nThe current
           layer has the TYPE %s.\nUpdate the property of your lef file with the correct syntax or remove this property from your
           lef file.\n", values_[index], type()); lefiError(msg);
        */
        sprintf(msg,
                "The property LEF57_SPACING with value %s is for TYPE CUT only.\nThe current layer has the TYPE %s.\nUpdate the "
                "property of your lef file with the correct syntax or remove this property from your lef file.\n",
                values_[index],
                type());
        lefError(1321, msg);
        free(wrkingStr);
      ...
      if (strcmp(value, "LAYER") == 0) {
        ...
        if (value && *value != '\n') {
          ...
          if (strcmp(value, "STACK") == 0) {
            ...
            if (*value != ';') {
              /*
                                   sprintf(msg, "ERROR (LEFPARS-1320): Incorrect syntax defined for property LEF57_SPACING:
            ...
            /*
               ...
               syntax is \"SPACING cutSpacing [CENTERTOCENTER][SAMENET]\n\t[LAYER secondLayerName[STACK]\n\t| ADJACENTCUTS {2 | 3 |
               4} WITHIN cutWithin [EXCEPTSAMEPGNET]\n\t| PARALLELOVERLAP\n\t| AREA cutArea ;\"", values_[index]); lefiError(msg);
            */
            sprintf(msg,
                    "Incorrect syntax defined for property LEF57_SPACING: %s.\nCorrect syntax is \"SPACING cutSpacing "
                    "[CENTERTOCENTER][SAMENET]\n\t[LAYER secondLayerName[STACK]\n\t| ADJACENTCUTS {2 | 3 | 4} WITHIN cutWithin "
      ...
      if (strcmp(type(), "ROUTING") != 0) {
        /*
           ...
           current layer has the TYPE %s.\nUpdate the property of your lef file with the correct syntax or remove this property from
           your lef file.\n", values_[index], type()); lefiError(msg);
        */
        sprintf(msg,
                "The property LEF57_SPACING with value %s is for TYPE ROUTING only.\nThe current layer has the TYPE %s.\nUpdate "
                "the property of your lef file with the correct syntax or remove this property from your lef file.\n",
                values_[index],
                type());
        lefError(1322, msg);
        free(wrkingStr);
      ...
      if (strcmp(value, "WITHIN") == 0) {
          ...
          if (strcmp(value, "PARALLELEDGE") == 0) {
            ...
            if (strcmp(value, "WITHIN") == 0) {
              ...
              if (value && *value != '\n') {
                ...
                /*
                                        sprintf(msg, "ERROR (LEFPARS-1305): Incorrect syntax defined for property LEF57_SPACING:
                   %s.\nCorrect syntax is \"SPACING minSpacing [CENTERTOCENTER]\"\n\"[LAYER secondLayerName | ADJACENTCUTS {2|3|4}
                   WITHIN cutWithin | PARALLELOVERLAP | AREA cutArea]\" or\n\"SPACING eolSpace ENDOFLINE eolWidth WITHIN eolWITHIN
                   [PARALLELEDGE parSpace WITHIN parWithin [TOWEDGES]]\"\n", values_[index]); lefiError(msg);
                */
                sprintf(msg,
                        "Incorrect syntax defined for property LEF57_SPACING: %s.\nCorrect syntax is \"SPACING minSpacing "
                        "[CENTERTOCENTER]\"\n\"[LAYER secondLayerName | ADJACENTCUTS {2|3|4} WITHIN cutWithin | PARALLELOVERLAP | "
                        "AREA cutArea]\" or\n\"SPACING eolSpace ENDOFLINE eolWidth WITHIN eolWITHIN [PARALLELEDGE parSpace WITHIN "
                        "parWithin [TOWEDGES]]\"\n",
                        values_[index]);
                lefError(1305, msg);
                free(wrkingStr);
        ...
        /*
           ...
           either \"SPACING minSpacing [CENTERTOCENTER]\"\n\"[LAYER secondLayerName | ADJACENTCUTS {2|3|4} WITHIN cutWithin |
           PARALLELOVERLAP | AREA cutArea]\" or\n\"SPACING eolSpace ENDOFLINE eolWidth WITHIN eolWITHIN [PARALLELEDGE parSpace
           WITHIN parWithin [TOWEDGES]]\"\n", values_[index]); lefiError(msg);
        */
        sprintf(msg,
                "Incorrect syntax defined for property LEF57_SPACING: %s.\nCorrect syntax is either \"SPACING minSpacing "
                "[CENTERTOCENTER]\"\n\"[LAYER secondLayerName | ADJACENTCUTS {2|3|4} WITHIN cutWithin | PARALLELOVERLAP | AREA "
                "cutArea]\" or\n\"SPACING eolSpace ENDOFLINE eolWidth WITHIN eolWITHIN [PARALLELEDGE parSpace WITHIN parWithin "
                "[TOWEDGES]]\"\n",
                values_[index]);
        lefError(1305, msg);
        free(wrkingStr);
    ...
    if (strcmp(value, "LONGARRAY") == 0) {
      if (cutSpacing != 0) {  // make sure syntax has correct order
        ...
        */
        sprintf(
            ...
            "is ARRAYSPACING [LONGARRAY] [WIDTH viaWidth] CUTSPACING cutSpacing\n\tARRAYCUTS arrayCuts SPACING arraySpacing ...\n",
            values_[index]);
        lefError(1308, msg);
        free(wrkingStr);
        return;
      ...
      */
      ...
      if (cutSpacing == 0) {  // make sure cutSpacing is already set
        ...
        required is either has not been defined or defined in a wrong location.\nCorrect syntax is ARRAYSPACING [LONGARRAY] [WIDTH
        viaWidth] CUTSPACING cutSpacing\n\tARRAYCUTS arrayCuts SPACING arraySpacing ...\n", values_[index]); lefiError(msg);
        */
        sprintf(msg,
                "Incorrect syntax defined for property LEF57_ARRAYSPACING: %s.\nCUTSPACING which is required is either has not "
                "been defined or defined in a wrong location.\nCorrect syntax is ARRAYSPACING [LONGARRAY] [WIDTH viaWidth] "
      ...
      if (strcmp(value, "SPACING") != 0) {
        /*
           ...
           should be defined with ARRAYCUTS.\nCorrect syntax is ARRAYSPACING [LONGARRAY] [WIDTH viaWidth] CUTSPACING
           cutSpacing\n\tARRAYCUTS arrayCuts SPACING arraySpacing ...\n", values_[index]); lefiError(msg);
        */
        sprintf(msg,
...
void lefiLayer::parseMinstep(int index) {
  ...
  if (strcmp(type(), "ROUTING") != 0) {
    /*
       ...
       has the TYPE %s.\nUpdate the property of your lef file with the correct syntax or remove this property from your lef
       file.\n", values_[index], type()); lefiError(msg);
    */
    sprintf(msg,
  ...
  if (strcmp(value, "MINSTEP") != 0) {
    /*
       ...
       minStepLength [MAXEDGES maxEdges] [MINADJACENTLENGTH minAdjLength | MINBETWEENLENGTH minBetweenLength [EXCEPTSAMECORNERS]]
       ;\"\n", values_[index]); lefiError(msg);
    */
    sprintf(msg,
            "Incorrect syntax defined for property LEF57_MINSTEP: %s.\nCorrect syntax is \"MINSTEP minStepLength [MAXEDGES "
            "maxEdges] [MINADJACENTLENGTH minAdjLength | MINBETWEENLENGTH minBetweenLength [EXCEPTSAMECORNERS]] ;\"\n",
            values_[index]);
    lefError(1315, msg);
    free(wrkingStr);
    return;
    ...
    if (value && *value != '\n') {
      if (strcmp(value, "MAXEDGES") == 0) {
        ...
        if (minBetLength) {
          ...
          /*
                         sprintf(msg, "ERROR (LEFPARS-1315): Incorrect syntax defined for property LEF57_MINSTEP: %s\nCorrect syntax
             is \"MINSTEP minStepLength [MAXEDGES maxEdges] [MINADJACENTLENGTH minAdjLength | MINBETWEENLENGTH minBetweenLength
             [EXCEPTSAMECORNERS]] ;\"\n", values_[index]); lefierror(msg);
          */
          sprintf(msg,
                  "Incorrect syntax defined for property LEF57_MINSTEP: %s\nCorrect syntax is \"MINSTEP minStepLength [MAXEDGES "
...
void lefiLayer::parseAntennaCumRouting(int index) {
  ...
  if (strcmp(value, "ANTENNACUMROUTINGPLUSCUT") != 0) {
    /*
       ...
       syntax is \"ANTANNACUMROUTINGPLUSCUT\"\n", values_[index]); lefiError(msg);
    */
    sprintf(msg,
...
void lefiLayer::parseAntennaGatePlus(int index) {
  ...
  if (strcmp(value, "ANTENNAGATEPLUSDIFF") != 0) {
    /*
       ...
       is \"ANTENNAGATEPLUSDIFF plusDiffFactor\"\n", values_[index]); lefiError(msg);
    */
    sprintf(msg,
            "Incorrect syntax defined for property LEF57_ANTENNAGATEPLUSDIFF: %s.\nCorrect syntax is \"ANTENNAGATEPLUSDIFF "
            "plusDiffFactor\"\n",
            values_[index]);
    lefError(1317, msg);
    free(wrkingStr);
...
void lefiLayer::parseAntennaAreaMinus(int index) {
  ...
  if (strcmp(value, "ANTENNAAREAMINUSDIFF") != 0) {
    /*
       ...
       is \"ANTENNAAREAMINUSDIFF minusDiffFactor\"\n", values_[index]); lefiError(msg);
    */
    sprintf(msg,
            "Incorrect syntax defined for property LEF57_ANTENNAAREAMINUSDIFF: %s.\nCorrect syntax is \"ANTENNAAREAMINUSDIFF "
            "minusDiffFactor\"\n",
            values_[index]);
    lefError(1318, msg);
    free(wrkingStr);
...
void lefiLayer::parseAntennaAreaDiff(int index) {
  ...
  if (strcmp(value, "ANTENNAAREADIFFREDUCEPWL") != 0) {
    /*
       ...
       syntax is \"ANTENNAAREADIFFREDUCEPWL (( diffArea1 metalDiffFactor1 ) ( diffArea2 metalDiffFactor2 )...)\"\n",
       values_[index]); lefiError(msg);
    */
    sprintf(msg,
            "Incorrect syntax defined for property LEF57_ANTENNAAREADIFFREDUCEPWL: %s.\nCorrect syntax is "
            "\"ANTENNAAREADIFFREDUCEPWL (( diffArea1 metalDiffFactor1 ) ( diffArea2 metalDiffFactor2 )...)\"\n",
            values_[index]);
    lefError(1319, msg);
    free(wrkingStr);
    return;
...
void lefiLayer::parseLayerType(int index) {
  ...
  if (firstToken != "TYPE") {
    std::string msg = "Incorrect LEF58_TYPE property value syntax: '" + propValue + "'. Correct syntax: 'TYPE <type> ;'.\n";
  ...
  if (layerLef58Types.empty()) {
    std::string msg = "Layers with TYPE " + type + " cannot have LEF58_TYPE property.\n";

    lefError(1328, msg.c_str());
  } else {
    std::string msg = "Property LEF58_TYPE has incorrect TYPE value: '" + lef58Type + "'. For TYPE " + type
...
int lefiLayer::need58PropsProcessing() const { return lefData->versionNum >= 5.7; }
