...
lefiNoiseVictim::lefiNoiseVictim(double d) : length_(0.0), numNoises_(0), noisesAllocated_(0), noises_(NULL) { Init(d); }
...
void lefiNoiseVictim::clear() { numNoises_ = 0; }
...
lefiNoiseVictim::~lefiNoiseVictim() { Destroy(); }
...
int lefiNoiseVictim::numNoises() const { return numNoises_; }

double lefiNoiseVictim::noise(int index) const { return noises_[index]; }

double lefiNoiseVictim::length() const { return length_; }
...
lefiNoiseResistance::lefiNoiseResistance()
    : numNums_(0), numsAllocated_(0), nums_(NULL), numVictims_(0), victimsAllocated_(0), victims_(NULL) {
  Init();
}
...
lefiNoiseResistance::~lefiNoiseResistance() { Destroy(); }
...
int lefiNoiseResistance::numVictims() const { return numVictims_; }

lefiNoiseVictim *lefiNoiseResistance::victim(int index) const { return victims_[index]; }

int lefiNoiseResistance::numNums() const { return numNums_; }

double lefiNoiseResistance::num(int index) const { return nums_[index]; }

// *****************************************************************************
// lefiNoiseEdge
// *****************************************************************************

lefiNoiseEdge::lefiNoiseEdge() { Init(); }
...
void lefiNoiseEdge::Init() {
  ...
  resistances_          = (lefiNoiseResistance **)lefMalloc(sizeof(lefiNoiseResistance *) * 2);
}
...
lefiNoiseEdge::~lefiNoiseEdge() { Destroy(); }

void lefiNoiseEdge::addEdge(double d) { edge_ = d; }
...
int lefiNoiseEdge::numResistances() { return numResistances_; }

lefiNoiseResistance *lefiNoiseEdge::resistance(int index) { return resistances_[index]; }

double lefiNoiseEdge::edge() { return edge_; }

// *****************************************************************************
// lefiNoiseTable
// *****************************************************************************

lefiNoiseTable::lefiNoiseTable() { Init(); }
...
lefiNoiseTable::~lefiNoiseTable() { Destroy(); }
...
int lefiNoiseTable::num() { return num_; }

int lefiNoiseTable::numEdges() { return numEdges_; }

lefiNoiseEdge *lefiNoiseTable::edge(int index) { return edges_[index]; }

// *****************************************************************************
// lefiCorrectionVictim
// *****************************************************************************

lefiCorrectionVictim::lefiCorrectionVictim(double d) { Init(d); }
...
void lefiCorrectionVictim::clear() { numCorrections_ = 0; }
...
lefiCorrectionVictim::~lefiCorrectionVictim() { Destroy(); }
...
int lefiCorrectionVictim::numCorrections() { return numCorrections_; }

double lefiCorrectionVictim::correction(int index) { return corrections_[index]; }

double lefiCorrectionVictim::length() { return length_; }

// *****************************************************************************
// lefiCorrectionResistance
// *****************************************************************************

lefiCorrectionResistance::lefiCorrectionResistance() { Init(); }
...
void lefiCorrectionResistance::Init() {
  ...
  numVictims_       = 0;
  victimsAllocated_ = 2;
  victims_          = (lefiCorrectionVictim **)lefMalloc(sizeof(lefiCorrectionVictim *) * 2);
}
...
lefiCorrectionResistance::~lefiCorrectionResistance() { Destroy(); }
...
int lefiCorrectionResistance::numVictims() { return numVictims_; }

lefiCorrectionVictim *lefiCorrectionResistance::victim(int index) { return victims_[index]; }

int lefiCorrectionResistance::numNums() { return numNums_; }

double lefiCorrectionResistance::num(int index) { return nums_[index]; }

// *****************************************************************************
// lefiCorrectionEdge
// *****************************************************************************

lefiCorrectionEdge::lefiCorrectionEdge() { Init(); }
...
void lefiCorrectionEdge::Init() {
  ...
  numResistances_       = 0;
  resistancesAllocated_ = 2;
  resistances_          = (lefiCorrectionResistance **)lefMalloc(sizeof(lefiCorrectionResistance *) * 2);
}
...
lefiCorrectionEdge::~lefiCorrectionEdge() { Destroy(); }

void lefiCorrectionEdge::addEdge(double d) { edge_ = d; }
...
int lefiCorrectionEdge::numResistances() { return numResistances_; }

lefiCorrectionResistance *lefiCorrectionEdge::resistance(int index) { return resistances_[index]; }

double lefiCorrectionEdge::edge() { return edge_; }

// *****************************************************************************
// lefiCorrectionTable
// *****************************************************************************

lefiCorrectionTable::lefiCorrectionTable() { Init(); }
...
lefiCorrectionTable::~lefiCorrectionTable() { Destroy(); }
...
int lefiCorrectionTable::num() { return num_; }

int lefiCorrectionTable::numEdges() { return numEdges_; }

lefiCorrectionEdge *lefiCorrectionTable::edge(int index) { return edges_[index]; }
