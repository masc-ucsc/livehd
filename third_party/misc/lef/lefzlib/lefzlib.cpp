 ...
 * Private functions:
 */
size_t lefGZip_read(FILE* file, char* buf, size_t len) { return (gzread((gzFile)file, buf, len)); }
...
int lefrReadGZip(lefGZFile file, const char* gzipFile, lefiUserData uData) { return lefrRead((FILE*)file, gzipFile, uData); }
