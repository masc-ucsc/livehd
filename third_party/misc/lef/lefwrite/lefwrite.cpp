...
int main(int argc, char **argv) {
  ...
  CHECK_STATUS(status);
  status = lefwViaViarule("DEFAULT", 0.1, 0.1, "metal1", "via12", "metal2", 0.1, 0.1, 0.05, 0.01, 0.01, 0.05);
  CHECK_STATUS(status);
  ...
  */
  ...
  CHECK_STATUS(status);
  status = lefwArraySite("CORE", -5021.450, -4998.000, 0, 14346, 595, 0.700, 16.800);
  CHECK_STATUS(status);
  status = lefwArraySiteStr("CORE", -5021.450, -4998.600, "FS", 14346, 595, 0.700, 16.800);
  CHECK_STATUS(status);
  ...
  CHECK_STATUS(status);
  status = lefwArrayCanplace("COVER", -7315.000, -7315.000, 0, 1, 1, 0.000, 0.000);
  CHECK_STATUS(status);
  status = lefwArrayCanplaceStr("COVER", -7250.000, -7250.000, "N", 5, 1, 40.000, 0.000);
  CHECK_STATUS(status);
  status = lefwArrayCannotoccupy("CORE", -5021.450, -4989.600, 6, 100, 595, 0.700, 16.800);
  CHECK_STATUS(status);
  status = lefwArrayCannotoccupyStr("CORE", -5021.450, -4989.600, "N", 100, 595, 0.700, 16.800);
  CHECK_STATUS(status);
  ...
  CHECK_STATUS(status);
  status = lefwArrayFloorplan("CANPLACE", "COVER", -7315.000, -7315.000, 1, 1, 1, 0.000, 0.000);
  CHECK_STATUS(status);
  status = lefwArrayFloorplanStr("CANPLACE", "COVER", -7250.000, -7250.000, "N", 5, 1, 40.000, 0.000);
  CHECK_STATUS(status);
  status = lefwArrayFloorplan("CANPLACE", "CORE", -5021.000, -4998.000, 1, 14346, 595, 0.700, 16.800);
  CHECK_STATUS(status);
  status = lefwArrayFloorplanStr("CANPLACE", "CORE", -5021.000, -4998.000, "FS", 100, 595, 0.700, 16.800);
  CHECK_STATUS(status);
  status = lefwArrayFloorplan("CANNOTOCCUPY", "CORE", -5021.000, -4998.000, 7, 14346, 595, 0.700, 16.800);
  CHECK_STATUS(status);
  status = lefwArrayFloorplanStr("CANNOTOCCUPY", "CORE", -5021.000, -4998.000, "E", 100, 595, 0.700, 16.800);
  CHECK_STATUS(status);
