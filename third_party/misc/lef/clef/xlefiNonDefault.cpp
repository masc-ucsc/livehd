...
const char* lefiNonDefault_name(const ::lefiNonDefault* obj) { return ((const LefDefParser::lefiNonDefault*)obj)->name(); }

int lefiNonDefault_hasHardspacing(const ::lefiNonDefault* obj) { return ((LefDefParser::lefiNonDefault*)obj)->hasHardspacing(); }

int lefiNonDefault_numProps(const ::lefiNonDefault* obj) { return ((LefDefParser::lefiNonDefault*)obj)->numProps(); }
...
int lefiNonDefault_numLayers(const ::lefiNonDefault* obj) { return ((LefDefParser::lefiNonDefault*)obj)->numLayers(); }
...
int lefiNonDefault_numVias(const ::lefiNonDefault* obj) { return ((LefDefParser::lefiNonDefault*)obj)->numVias(); }
...
int lefiNonDefault_numSpacingRules(const ::lefiNonDefault* obj) { return ((LefDefParser::lefiNonDefault*)obj)->numSpacingRules(); }
...
int lefiNonDefault_numUseVia(const ::lefiNonDefault* obj) { return ((LefDefParser::lefiNonDefault*)obj)->numUseVia(); }
...
int lefiNonDefault_numUseViaRule(const ::lefiNonDefault* obj) { return ((LefDefParser::lefiNonDefault*)obj)->numUseViaRule(); }
...
int lefiNonDefault_numMinCuts(const ::lefiNonDefault* obj) { return ((LefDefParser::lefiNonDefault*)obj)->numMinCuts(); }
...
int lefiNonDefault_numCuts(const ::lefiNonDefault* obj, int index) { return ((LefDefParser::lefiNonDefault*)obj)->numCuts(index); }
