...
int lefiArray_numSitePattern(const ::lefiArray* obj) { return ((LefDefParser::lefiArray*)obj)->numSitePattern(); }

int lefiArray_numCanPlace(const ::lefiArray* obj) { return ((LefDefParser::lefiArray*)obj)->numCanPlace(); }

int lefiArray_numCannotOccupy(const ::lefiArray* obj) { return ((LefDefParser::lefiArray*)obj)->numCannotOccupy(); }

int lefiArray_numTrack(const ::lefiArray* obj) { return ((LefDefParser::lefiArray*)obj)->numTrack(); }

int lefiArray_numGcell(const ::lefiArray* obj) { return ((LefDefParser::lefiArray*)obj)->numGcell(); }

int lefiArray_hasDefaultCap(const ::lefiArray* obj) { return ((LefDefParser::lefiArray*)obj)->hasDefaultCap(); }

const char* lefiArray_name(const ::lefiArray* obj) { return ((const LefDefParser::lefiArray*)obj)->name(); }
...
int lefiArray_tableSize(const ::lefiArray* obj) { return ((LefDefParser::lefiArray*)obj)->tableSize(); }

int lefiArray_numDefaultCaps(const ::lefiArray* obj) { return ((LefDefParser::lefiArray*)obj)->numDefaultCaps(); }

int lefiArray_defaultCapMinPins(const ::lefiArray* obj, int index) {
  return ((LefDefParser::lefiArray*)obj)->defaultCapMinPins(index);
}

double lefiArray_defaultCap(const ::lefiArray* obj, int index) { return ((LefDefParser::lefiArray*)obj)->defaultCap(index); }

int lefiArray_numFloorPlans(const ::lefiArray* obj) { return ((LefDefParser::lefiArray*)obj)->numFloorPlans(); }
...
int lefiArray_numSites(const ::lefiArray* obj, int index) { return ((LefDefParser::lefiArray*)obj)->numSites(index); }
...
void lefiArray_print(const ::lefiArray* obj, FILE* f) { ((LefDefParser::lefiArray*)obj)->print(f); }
