...
int lefiAntennaPWL_numPWL(const ::lefiAntennaPWL* obj) { return ((LefDefParser::lefiAntennaPWL*)obj)->numPWL(); }

char* lefiLayerDensity_type(const ::lefiLayerDensity* obj) { return ((LefDefParser::lefiLayerDensity*)obj)->type(); }

int lefiLayerDensity_hasOneEntry(const ::lefiLayerDensity* obj) { return ((LefDefParser::lefiLayerDensity*)obj)->hasOneEntry(); }

double lefiLayerDensity_oneEntry(const ::lefiLayerDensity* obj) { return ((LefDefParser::lefiLayerDensity*)obj)->oneEntry(); }

int lefiLayerDensity_numFrequency(const ::lefiLayerDensity* obj) { return ((LefDefParser::lefiLayerDensity*)obj)->numFrequency(); }
...
int lefiLayerDensity_numWidths(const ::lefiLayerDensity* obj) { return ((LefDefParser::lefiLayerDensity*)obj)->numWidths(); }
...
int lefiLayerDensity_numCutareas(const ::lefiLayerDensity* obj) { return ((LefDefParser::lefiLayerDensity*)obj)->numCutareas(); }
...
int lefiParallel_numLength(const ::lefiParallel* obj) { return ((LefDefParser::lefiParallel*)obj)->numLength(); }

int lefiParallel_numWidth(const ::lefiParallel* obj) { return ((LefDefParser::lefiParallel*)obj)->numWidth(); }

double lefiParallel_length(const ::lefiParallel* obj, int iLength) { return ((LefDefParser::lefiParallel*)obj)->length(iLength); }

double lefiParallel_width(const ::lefiParallel* obj, int iWidth) { return ((LefDefParser::lefiParallel*)obj)->width(iWidth); }
...
int lefiInfluence_numInfluenceEntry(const ::lefiInfluence* obj) { return ((LefDefParser::lefiInfluence*)obj)->numInfluenceEntry(); }

double lefiInfluence_width(const ::lefiInfluence* obj, int index) { return ((LefDefParser::lefiInfluence*)obj)->width(index); }

double lefiInfluence_distance(const ::lefiInfluence* obj, int index) {
  return ((LefDefParser::lefiInfluence*)obj)->distance(index);
}

double lefiInfluence_spacing(const ::lefiInfluence* obj, int index) { return ((LefDefParser::lefiInfluence*)obj)->spacing(index); }

int lefiTwoWidths_numWidth(const ::lefiTwoWidths* obj) { return ((LefDefParser::lefiTwoWidths*)obj)->numWidth(); }

double lefiTwoWidths_width(const ::lefiTwoWidths* obj, int iWidth) { return ((LefDefParser::lefiTwoWidths*)obj)->width(iWidth); }
...
int lefiSpacingTable_isInfluence(const ::lefiSpacingTable* obj) { return ((LefDefParser::lefiSpacingTable*)obj)->isInfluence(); }
...
int lefiSpacingTable_isParallel(const ::lefiSpacingTable* obj) { return ((LefDefParser::lefiSpacingTable*)obj)->isParallel(); }
...
int lefiOrthogonal_numOrthogonal(const ::lefiOrthogonal* obj) { return ((LefDefParser::lefiOrthogonal*)obj)->numOrthogonal(); }
...
int lefiLayer_hasType(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->hasType(); }

int lefiLayer_hasLayerType(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->hasLayerType(); }

int lefiLayer_hasMask(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->hasMask(); }

int lefiLayer_hasPitch(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->hasPitch(); }

int lefiLayer_hasXYPitch(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->hasXYPitch(); }

int lefiLayer_hasOffset(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->hasOffset(); }

int lefiLayer_hasXYOffset(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->hasXYOffset(); }

int lefiLayer_hasWidth(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->hasWidth(); }

int lefiLayer_hasArea(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->hasArea(); }

int lefiLayer_hasDiagPitch(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->hasDiagPitch(); }

int lefiLayer_hasXYDiagPitch(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->hasXYDiagPitch(); }

int lefiLayer_hasDiagWidth(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->hasDiagWidth(); }

int lefiLayer_hasDiagSpacing(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->hasDiagSpacing(); }

int lefiLayer_hasSpacingNumber(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->hasSpacingNumber(); }

int lefiLayer_hasSpacingName(const ::lefiLayer* obj, int index) { return ((LefDefParser::lefiLayer*)obj)->hasSpacingName(index); }
...
int lefiLayer_hasSpacingRange(const ::lefiLayer* obj, int index) { return ((LefDefParser::lefiLayer*)obj)->hasSpacingRange(index); }
...
int lefiLayer_hasSpacingArea(const ::lefiLayer* obj, int index) { return ((LefDefParser::lefiLayer*)obj)->hasSpacingArea(index); }
...
int lefiLayer_hasDirection(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->hasDirection(); }

int lefiLayer_hasResistance(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->hasResistance(); }

int lefiLayer_hasResistanceArray(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->hasResistanceArray(); }

int lefiLayer_hasCapacitance(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->hasCapacitance(); }

int lefiLayer_hasCapacitanceArray(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->hasCapacitanceArray(); }

int lefiLayer_hasHeight(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->hasHeight(); }

int lefiLayer_hasThickness(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->hasThickness(); }

int lefiLayer_hasWireExtension(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->hasWireExtension(); }

int lefiLayer_hasShrinkage(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->hasShrinkage(); }

int lefiLayer_hasCapMultiplier(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->hasCapMultiplier(); }

int lefiLayer_hasEdgeCap(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->hasEdgeCap(); }

int lefiLayer_hasAntennaLength(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->hasAntennaLength(); }

int lefiLayer_hasAntennaArea(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->hasAntennaArea(); }

int lefiLayer_hasCurrentDensityPoint(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->hasCurrentDensityPoint(); }

int lefiLayer_hasCurrentDensityArray(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->hasCurrentDensityArray(); }

int lefiLayer_hasAccurrentDensity(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->hasAccurrentDensity(); }

int lefiLayer_hasDccurrentDensity(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->hasDccurrentDensity(); }

int lefiLayer_numProps(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->numProps(); }

const char* lefiLayer_propName(const ::lefiLayer* obj, int index) { return ((const LefDefParser::lefiLayer*)obj)->propName(index); }

const char* lefiLayer_propValue(const ::lefiLayer* obj, int index) {
  return ((const LefDefParser::lefiLayer*)obj)->propValue(index);
}

double lefiLayer_propNumber(const ::lefiLayer* obj, int index) { return ((LefDefParser::lefiLayer*)obj)->propNumber(index); }

const char lefiLayer_propType(const ::lefiLayer* obj, int index) { return ((const LefDefParser::lefiLayer*)obj)->propType(index); }

int lefiLayer_propIsNumber(const ::lefiLayer* obj, int index) { return ((LefDefParser::lefiLayer*)obj)->propIsNumber(index); }

int lefiLayer_propIsString(const ::lefiLayer* obj, int index) { return ((LefDefParser::lefiLayer*)obj)->propIsString(index); }

int lefiLayer_numSpacing(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->numSpacing(); }

char* lefiLayer_name(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->name(); }

const char* lefiLayer_type(const ::lefiLayer* obj) { return ((const LefDefParser::lefiLayer*)obj)->type(); }

const char* lefiLayer_layerType(const ::lefiLayer* obj) { return ((const LefDefParser::lefiLayer*)obj)->layerType(); }

double lefiLayer_pitch(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->pitch(); }

int lefiLayer_mask(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->mask(); }

double lefiLayer_pitchX(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->pitchX(); }

double lefiLayer_pitchY(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->pitchY(); }

double lefiLayer_offset(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->offset(); }

double lefiLayer_offsetX(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->offsetX(); }

double lefiLayer_offsetY(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->offsetY(); }

double lefiLayer_width(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->width(); }

double lefiLayer_area(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->area(); }

double lefiLayer_diagPitch(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->diagPitch(); }

double lefiLayer_diagPitchX(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->diagPitchX(); }

double lefiLayer_diagPitchY(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->diagPitchY(); }

double lefiLayer_diagWidth(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->diagWidth(); }

double lefiLayer_diagSpacing(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->diagSpacing(); }

double lefiLayer_spacing(const ::lefiLayer* obj, int index) { return ((LefDefParser::lefiLayer*)obj)->spacing(index); }

char* lefiLayer_spacingName(const ::lefiLayer* obj, int index) { return ((LefDefParser::lefiLayer*)obj)->spacingName(index); }
...
double lefiLayer_spacingArea(const ::lefiLayer* obj, int index) { return ((LefDefParser::lefiLayer*)obj)->spacingArea(index); }
...
int lefiLayer_numMinimumcut(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->numMinimumcut(); }

int lefiLayer_minimumcut(const ::lefiLayer* obj, int index) { return ((LefDefParser::lefiLayer*)obj)->minimumcut(index); }
...
const char* lefiLayer_direction(const ::lefiLayer* obj) { return ((const LefDefParser::lefiLayer*)obj)->direction(); }

double lefiLayer_resistance(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->resistance(); }

double lefiLayer_capacitance(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->capacitance(); }

double lefiLayer_height(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->height(); }

double lefiLayer_wireExtension(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->wireExtension(); }

double lefiLayer_thickness(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->thickness(); }

double lefiLayer_shrinkage(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->shrinkage(); }

double lefiLayer_capMultiplier(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->capMultiplier(); }

double lefiLayer_edgeCap(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->edgeCap(); }

double lefiLayer_antennaLength(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->antennaLength(); }

double lefiLayer_antennaArea(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->antennaArea(); }

double lefiLayer_currentDensityPoint(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->currentDensityPoint(); }
...
int lefiLayer_numAccurrentDensity(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->numAccurrentDensity(); }
...
int lefiLayer_numDccurrentDensity(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->numDccurrentDensity(); }
...
int lefiLayer_numAntennaModel(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->numAntennaModel(); }
...
int lefiLayer_hasSlotWireWidth(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->hasSlotWireWidth(); }

int lefiLayer_hasSlotWireLength(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->hasSlotWireLength(); }

int lefiLayer_hasSlotWidth(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->hasSlotWidth(); }

int lefiLayer_hasSlotLength(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->hasSlotLength(); }
...
int lefiLayer_hasMaxEdgeSlotSpacing(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->hasMaxEdgeSlotSpacing(); }

int lefiLayer_hasSplitWireWidth(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->hasSplitWireWidth(); }

int lefiLayer_hasMinimumDensity(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->hasMinimumDensity(); }

int lefiLayer_hasMaximumDensity(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->hasMaximumDensity(); }

int lefiLayer_hasDensityCheckWindow(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->hasDensityCheckWindow(); }

int lefiLayer_hasDensityCheckStep(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->hasDensityCheckStep(); }

int lefiLayer_hasFillActiveSpacing(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->hasFillActiveSpacing(); }

int lefiLayer_hasMaxwidth(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->hasMaxwidth(); }

int lefiLayer_hasMinwidth(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->hasMinwidth(); }

int lefiLayer_hasMinstep(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->hasMinstep(); }

int lefiLayer_hasProtrusion(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->hasProtrusion(); }

double lefiLayer_slotWireWidth(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->slotWireWidth(); }

double lefiLayer_slotWireLength(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->slotWireLength(); }

double lefiLayer_slotWidth(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->slotWidth(); }

double lefiLayer_slotLength(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->slotLength(); }

double lefiLayer_maxAdjacentSlotSpacing(const ::lefiLayer* obj) {
  return ((LefDefParser::lefiLayer*)obj)->maxAdjacentSlotSpacing();
}

double lefiLayer_maxCoaxialSlotSpacing(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->maxCoaxialSlotSpacing(); }
...
double lefiLayer_minimumDensity(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->minimumDensity(); }

double lefiLayer_maximumDensity(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->maximumDensity(); }
...
double lefiLayer_densityCheckStep(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->densityCheckStep(); }

double lefiLayer_fillActiveSpacing(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->fillActiveSpacing(); }

double lefiLayer_maxwidth(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->maxwidth(); }

double lefiLayer_minwidth(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->minwidth(); }

double lefiLayer_protrusionWidth1(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->protrusionWidth1(); }

double lefiLayer_protrusionLength(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->protrusionLength(); }

double lefiLayer_protrusionWidth2(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->protrusionWidth2(); }

int lefiLayer_numMinstep(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->numMinstep(); }

double lefiLayer_minstep(const ::lefiLayer* obj, int index) { return ((LefDefParser::lefiLayer*)obj)->minstep(index); }

int lefiLayer_hasMinstepType(const ::lefiLayer* obj, int index) { return ((LefDefParser::lefiLayer*)obj)->hasMinstepType(index); }

char* lefiLayer_minstepType(const ::lefiLayer* obj, int index) { return ((LefDefParser::lefiLayer*)obj)->minstepType(index); }
...
int lefiLayer_minstepMaxedges(const ::lefiLayer* obj, int index) { return ((LefDefParser::lefiLayer*)obj)->minstepMaxedges(index); }
...
int lefiLayer_numMinenclosedarea(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->numMinenclosedarea(); }
...
int lefiLayer_numEnclosure(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->numEnclosure(); }
...
int lefiLayer_numPreferEnclosure(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->numPreferEnclosure(); }
...
int lefiLayer_hasResistancePerCut(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->hasResistancePerCut(); }

double lefiLayer_resistancePerCut(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->resistancePerCut(); }

int lefiLayer_hasDiagMinEdgeLength(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->hasDiagMinEdgeLength(); }

double lefiLayer_diagMinEdgeLength(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->diagMinEdgeLength(); }

int lefiLayer_numMinSize(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->numMinSize(); }

double lefiLayer_minSizeWidth(const ::lefiLayer* obj, int index) { return ((LefDefParser::lefiLayer*)obj)->minSizeWidth(index); }

double lefiLayer_minSizeLength(const ::lefiLayer* obj, int index) { return ((LefDefParser::lefiLayer*)obj)->minSizeLength(index); }

int lefiLayer_hasMaxFloatingArea(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->hasMaxFloatingArea(); }

double lefiLayer_maxFloatingArea(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->maxFloatingArea(); }

int lefiLayer_hasArraySpacing(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->hasArraySpacing(); }

int lefiLayer_hasLongArray(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->hasLongArray(); }

int lefiLayer_hasViaWidth(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->hasViaWidth(); }

double lefiLayer_viaWidth(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->viaWidth(); }

double lefiLayer_cutSpacing(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->cutSpacing(); }

int lefiLayer_numArrayCuts(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->numArrayCuts(); }

int lefiLayer_arrayCuts(const ::lefiLayer* obj, int index) { return ((LefDefParser::lefiLayer*)obj)->arrayCuts(index); }

double lefiLayer_arraySpacing(const ::lefiLayer* obj, int index) { return ((LefDefParser::lefiLayer*)obj)->arraySpacing(index); }

int lefiLayer_hasSpacingTableOrtho(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->hasSpacingTableOrtho(); }
...
int lefiLayer_need58PropsProcessing(const ::lefiLayer* obj) { return ((LefDefParser::lefiLayer*)obj)->need58PropsProcessing(); }

void lefiLayer_print(const ::lefiLayer* obj, FILE* f) { ((LefDefParser::lefiLayer*)obj)->print(f); }
