...
double lefiNoiseVictim_length(const ::lefiNoiseVictim* obj) { return ((LefDefParser::lefiNoiseVictim*)obj)->length(); }

int lefiNoiseVictim_numNoises(const ::lefiNoiseVictim* obj) { return ((LefDefParser::lefiNoiseVictim*)obj)->numNoises(); }

double lefiNoiseVictim_noise(const ::lefiNoiseVictim* obj, int index) {
  return ((LefDefParser::lefiNoiseVictim*)obj)->noise(index);
}

int lefiNoiseResistance_numNums(const ::lefiNoiseResistance* obj) { return ((LefDefParser::lefiNoiseResistance*)obj)->numNums(); }
