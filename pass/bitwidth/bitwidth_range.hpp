...
protected:
  static Dlop to_lconst(bool overflow, int64_t val);
...
public:
  ...
  Bitwidth_range(const Dlop& value);
  Bitwidth_range(const Dlop& min_val, const Dlop& max_val);
  ...
  Bitwidth_range(const Dlop& min_val, const spool_ptr<Dlop>& max_val) : Bitwidth_range(min_val, *max_val) {}
  Bitwidth_range(const spool_ptr<Dlop>& min_val, const Dlop& max_val) : Bitwidth_range(*min_val, max_val) {}
  ...
  void set_wider_range(const Dlop& min_val, const spool_ptr<Dlop>& max_val) { set_wider_range(min_val, *max_val); }
  void set_wider_range(const spool_ptr<Dlop>& min_val, const Dlop& max_val) { set_wider_range(*min_val, max_val); }

  void set_range(const Dlop& min_val, const Dlop& max_val);
  void set_range(const spool_ptr<Dlop>& min_val, const Dlop& max_val) { set_range(*min_val, max_val); }
  void set_range(const Dlop& min_val, const spool_ptr<Dlop>& max_val) { set_range(min_val, *max_val); }
