...
pts='SubModule BundleConnect LogShifter Adder4 Xor6Thread2 XorSelfThread1 Cell_alone ByteSelector SimpleALU Mux4 
Max2 ResetShiftRegister Parity RegisterSimple Register RegXor AddNot
GCD_3bits Flop Test3 TrivialAdd NotAnd
Trivial Tail TrivialArith Shifts Darken HiLoMultiplier Accumulator
