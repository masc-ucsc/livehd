...
scalar_reg_out_pre_declare firrtl_tail2 
...
#pts = 'hier_tuple_nested_if hier_tuple_nested_if4 hier_tuple_nested_if5 firrtl_tail firrtl_gcd_3bits firrtl_tail3 tuple_reg struct_flop tuple_nested2 get_mask1 vec_shift_register_param  '
