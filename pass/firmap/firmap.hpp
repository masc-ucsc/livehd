...
protected:
  ...
  LGraph* firrtl_lgraph_mapping(LGraph *lg);
  ...
  void process_fir_ops(Node &node, std::string_view op);
  void process_fir_add_sub(Node &node, XEdge_iterator &inp_edges, std::string_view op);
