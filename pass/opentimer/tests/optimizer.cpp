...
int main(int argc, char *argv[]) {
  ...
  std::cout << "Late/Fall slack at pin G17: " << *timer.report_slack("G17", ot::MAX, ot::FALL) << '\n';

  // report the arrival time at G17
  std::cout << "Late/Fall arrival time at pin G17: " << *timer.report_at("G17", ot::MAX, ot::FALL) << '\n';

  // report the required arrival time at G17
  std::cout << "Late/Fall required arrival time at pin G17: " << *timer.report_rat("G17", ot::MAX, ot::FALL) << '\n';
