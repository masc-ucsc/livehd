...
DESTLOCATION=/home/sgarg3/livehd/pass/locator/tests/dummy_WOFlopChange_12march2024_R1 #change line 80/81 in test_NL2NL.py for flops/no_flops as well
...
for FILENAME in RocketTile_yosys_DT2   #RocketTile_yosys_DT2 SingleCycleCPU_yosysFlat PipelinedCPU_yosysFlat_DT30p MaxPeriodFibonacciLFSR 
do
  ...
  for PERCENTAGE_CHANGE in 0 10 20 40 60 80 90 100 
  do
    ...
    then
      ...
      perf record -g /usr/bin/time -o ${DESTLOCATION}/${FILENAME}_${PERCENTAGE_CHANGE}_time.log ./bazel-bin/main/lgshell " inou.yosys.tolg files:${SRCLOCATION}/${FILENAME}.v |> pass.cprop |> pass.bitwidth 
      inou.yosys.tolg files:${DESTLOCATION}/${FILENAME}_1_new.v |> pass.cprop |> pass.bitwidth 
      lgraph.open name:${ORIG_NL} |> lgraph.open name:${NEW_NL} |> lgraph.dump |> inou.traverse_lg LGorig:${ORIG_NL} LGsynth:${NEW_NL} 
      " > ${DESTLOCATION}/${FILENAME}_${PERCENTAGE_CHANGE}.log
    elif [ ${FILENAME} == "RocketTile_yosys_DT2" ]
    then
      echo ""
    ...
    python3 pass/locator/nl2nlTimePlot.py ${DESTLOCATION}/${FILENAME}_${PERCENTAGE_CHANGE}_time.log ${DESTLOCATION}/${FILENAME}_${PERCENTAGE_CHANGE}_perf_report.log ${DESTLOCATION}/nl2nl_time_flop_plot_data.py  #FIXME! SIMPLIFY FOR TIME REding!
