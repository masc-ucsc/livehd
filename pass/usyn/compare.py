...
"""Serial, guarded comparison of pass.usyn and pass.abc on identical colors."""
import argparse
import json
...
def main():
    ...
    parser.add_argument("--usyn-set", action="append", default=[], metavar="FLAG=VALUE",
                        help="pass.usyn option for the unate side, e.g. support=2 or abc=tmap (repeatable)")
    ...
    report = {"schema_version": 1, "top": args.top, "source": source, "liberty": liberty,
              ...
              "usyn_totals": usyn["totals"], "usyn_report": str(root / "usyn/qor.json.usyn.json")}
