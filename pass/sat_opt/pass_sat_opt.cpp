...
2. Tracerse the graph forward, foreach node, it's inputs are already assigned SAT variables, assign SAT variables to the node output and add SAT formula to the solver based on node type
