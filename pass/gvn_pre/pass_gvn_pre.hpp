...
public:
  Node_pin_Plus(Index_ID _nid, Port_ID _pid, bool _input) : Node_pin(_nid, _pid, _input) {}

  Node_pin_Plus(Node_pin _node_pin) : Node_pin(_node_pin.get_nid(), _node_pin.get_pid(), false) {}

  Node_pin_Plus() : Node_pin(-1, -1, false) {}
