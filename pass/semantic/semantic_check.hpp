...
protected:
  ...
  using FlatHashSet = absl::flat_hash_set<std::string>;
  ...
  std::vector<std::string> out_of_scope_vars;
  ...
  void error_print_lnast_var_warn(Lnast* lnast, std::vector<std::string> error_names);
