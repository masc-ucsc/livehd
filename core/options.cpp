...
Options_pack::Options_pack() {
  ...
  if(!initialized) {
    ...
    Options::get_desc()->add_options()("lgdb", boost::program_options::value(&lgdb_path), "lg db path")("graph_name", boost::program_options::value(&graph_name), "graph name in the lg db path")("help,h", "print usage message");
  }
