...
class Ntype {
protected:
  inline static constexpr std::string_view cell_name[] = {"Invalid",     "Sum",     "Mult",   "Div",
...
public:
  ...
  static inline constexpr bool is_synthesizable(Ntype_op op) {
    return op != Ntype_op::Sub && op != Ntype_op::Tposs && op != Ntype_op::Sext && op != Ntype_op::TupAdd && op != Ntype_op::TupGet
