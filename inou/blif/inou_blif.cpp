...
Inou_blif_options_pack::Inou_blif_options_pack() {
  Options::get_desc()->add_options()("blif_output,o", boost::program_options::value(&blif_output), "blif output <filename> for graph")("verbose,v", boost::program_options::value(&verbose), "verbose output");
