...
module \instance_state_anon.lane_acc (
  input        clock,
  input        reset,
  input  [7:0] a,
  output [7:0] s
...
module \instance_state_anon.top (
  ...
  \instance_state_anon.lane_acc  ua0(.clock(clock), .reset(reset), .a(d[7:0]),   .s(s0));
  \instance_state_anon.lane_acc  ua1(.clock(clock), .reset(reset), .a(d[15:8]),  .s(s1));
  \instance_state_anon.lane_acc  ua2(.clock(clock), .reset(reset), .a(d[23:16]), .s(s2));
  \instance_state_anon.lane_acc  ua3(.clock(clock), .reset(reset), .a(d[31:24]), .s(s3));
