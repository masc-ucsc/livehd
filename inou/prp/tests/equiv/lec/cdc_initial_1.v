/*
src_level stored complemented, sync reset folded into the next-state logic.
The bounded proof must complete after the reset-hold prologue.
:lec_grep: PASS\(6\) equivalent
*/
