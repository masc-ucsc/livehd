...
do
    ...
    ${LGSHELL} "inou.firrtl.tolnast files:inou/firrtl/tests/proto/${pt}.hi.pb |> pass.lnast_tolg.dbg_lnast_ssa |> inou.graphviz.from"
    ...
    ${LGSHELL} "inou.firrtl.tolnast files:inou/firrtl/tests/proto/${pt}.hi.pb |> pass.lnast_tolg |> pass.cprop |> pass.bitwidth |> pass.cprop |> pass.bitwidth |> pass.cprop |> pass.bitwidth |> pass.bitwidth"
    if [ $? -eq 0 ]; then
