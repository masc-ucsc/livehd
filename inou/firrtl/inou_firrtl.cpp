...
void Inou_firrtl::setup() {
  ...
  Eprp_method m2(mmap_lib::str("inou.firrtl.tofirrtl"), mmap_lib::str("LNAST to FIRRTL"), &Inou_firrtl::toFIRRTL);
  m2.add_label_optional("odir", mmap_lib::str("output directory for generated firrtl files"), ".");
