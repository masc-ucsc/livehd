...
~/pyrope/parser/bin/prp sp_if_1.prp            > yyy && column -t yyy > xxx && mv xxx sp_if_1.cfg     && rm -f yyy 
~/pyrope/parser/bin/prp sp_if_2.prp            > yyy && column -t yyy > xxx && mv xxx sp_if_2.cfg     && rm -f yyy
~/pyrope/parser/bin/prp sp_if_3.prp            > yyy && column -t yyy > xxx && mv xxx sp_if_3.cfg     && rm -f yyy
