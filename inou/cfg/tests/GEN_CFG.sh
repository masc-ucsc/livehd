...
~/pyrope/parser/bin/prp constant_pos.prp > yyy && column -t yyy > xxx && mv xxx constant_pos.cfg
~/pyrope/parser/bin/prp constant_neg.prp > yyy && column -t yyy > xxx && mv xxx constant_neg.cfg
