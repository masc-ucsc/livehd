...
private:
  ...
  Lnast_nid              buffer_tmp_func_def_name_idx;  // FIXME->sh: need expand to a set when the import prp library supported or
                                           // multi-function defined in a same prp
