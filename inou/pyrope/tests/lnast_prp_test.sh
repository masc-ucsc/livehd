...
#  pts='sync_cnt_nested_if'
  pts='counter counter_nested_if '
#  pts='firrtl_tail2'
#  pts='adder_stage reg__q_pin tuple_if2 '
#  pts='ssa_rhs adder_stage reg__q_pin firrtl_tail tuple_if out_ssa if2 if nested_if if3_err nested_if_err logic '
