...
#  pts='test2'
  pts=' tuple_if2 firrtl_tail2 counter counter_nested_if ssa_rhs adder_stage reg__q_pin firrtl_tail tuple_if out_ssa if2 if nested_if if3_err nested_if_err logic '
