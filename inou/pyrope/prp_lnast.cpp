...
Lnast_node Prp_lnast::eval_rule(mmap_lib::Tree_index idx_start_ast, mmap_lib::Tree_index idx_start_ln){
  ...
  switch(node.rule_id){
      case Prp_invalid:
        PRINT_DBG_LN("Prp_invalid\n");
        break;
      case Prp_rule:
        PRINT_DBG_LN("Prp_rule\n");
        break;
      case Prp_rule_start:
        PRINT_DBG_LN("Prp_start\n");
        break;
      case Prp_rule_code_blocks:
        PRINT_DBG_LN("Prp_rule_code_blocks\n");
        break;
      case Prp_rule_code_block_int:
        PRINT_DBG_LN("Prp_rule_code_block_int\n");
        break;
      ...
      case Prp_rule_else_statement:
        PRINT_DBG_LN("Prp_rule_else_statement\n");
        break;
      ...
      case Prp_rule_try_statement:
        PRINT_DBG_LN("Prp_rule_try_statement\n");
        break;
      case Prp_rule_punch_format:
        PRINT_DBG_LN("Prp_rule_punch_format\n");
        break;
      case Prp_rule_function_pipe:
        PRINT_DBG_LN("Prp_rule_function_pipe\n");
        break;
      ...
      case Prp_rule_tuple_by_notation:
        PRINT_DBG_LN("Prp_rule_tuple_by_notation\n");
        break;
      case Prp_rule_tuple_notation_no_bracket:
        PRINT_DBG_LN("Prp_rule_tuple_notation_no_bracket\n");
        break;
      ...
      case Prp_rule_tuple_notation_with_object:
        PRINT_DBG_LN("Prp_rule_tuple_notation_with_object\n");
        break;
      ...
      case Prp_rule_bit_selection_bracket:
        PRINT_DBG_LN("Prp_rule_bit_selection_bracket\n");
        break;
      ...
      case Prp_rule_tuple_array_bracket:
        PRINT_DBG_LN("Prp_rule_tuple_array_bracket\n");
        break;
      ...
      case Prp_rule_lhs_expression:
        PRINT_DBG_LN("Prp_rule_lhs_expression\n");
        break;
      case Prp_rule_lhs_var_name:
        PRINT_DBG_LN("Prp_rule_var_name\n");
        break;
      case Prp_rule_rhs_expression_property:
        PRINT_DBG_LN("Prp_rule_rhs_expression_property\n");
        break;
      case Prp_rule_rhs_expression:
        PRINT_DBG_LN("Prp_rule_rhs_expression\n");
        break;
      ...
      case Prp_rule_assignment_operator:
        PRINT_DBG_LN("Prp_rule_assignment_operator\n");
        break;
      ...
      case Prp_rule_tuple_dot_dot:
        PRINT_DBG_LN("Prp_rule_tuple_dot_dot\n");
        break;
      case Prp_rule_overload_notation:
        PRINT_DBG_LN("Prp_rule_overload_notation\n");
        break;
      case Prp_rule_scope_else:
        PRINT_DBG_LN("Prp_rule_scope_else\n");
        break;
      case Prp_rule_scope_body:
        PRINT_DBG_LN("Prp_rule_scope_body\n");
        break;
      case Prp_rule_scope_declaration:
        ...
        break;
      case Prp_rule_scope:
        PRINT_DBG_LN("Prp_rule_scope\n");
        break;
      case Prp_rule_scope_condition:
        PRINT_DBG_LN("Prp_rule_scope_condition\n");
        break;
      case Prp_rule_scope_argument:
        PRINT_DBG_LN("Prp_rule_scope_argument\n");
        break;
      case Prp_rule_punch_rhs:
        PRINT_DBG_LN("Prp_rule_punch_rhs\n");
        break;
      ...
      case Prp_rule_return_statement:
        PRINT_DBG_LN("Prp_rule_return_statement\n");
        break;
      case Prp_rule_compile_check_statement:
        PRINT_DBG_LN("Prp_rule_compile_check_statement\n");
        break;
      case Prp_rule_block_body:
        PRINT_DBG_LN("Prp_rule_block_body\n");
        break;
      case Prp_rule_empty_scope_colon:
        PRINT_DBG_LN("Prp_rule_empty_scope_colon\n");
        break;
      case Prp_rule_assertion_statement:
        PRINT_DBG_LN("Prp_rule_assertion_statement\n");
        break;
      case Prp_rule_negation_statement:
        PRINT_DBG_LN("Prp_rule_negation_statement\n");
        break;
      case Prp_rule_scope_colon:
        PRINT_DBG_LN("Prp_rule_scope_colon\n");
        break;
      ...
      case Prp_rule_overload_name:
        PRINT_DBG_LN("Prp_rule_overload_name\n");
        break;
      case Prp_rule_overload_exception:
        PRINT_DBG_LN("Prp_rule_overload_exception\n");
        break;
      ...
      case Prp_rule_not_in_implicit:
        PRINT_DBG_LN("Prp_rule_not_in_implicit\n");
        break;
      case Prp_rule_keyword:
        PRINT_DBG_LN("Prp_rule_keyword\n");
        break;
      default:
        break;
    }
