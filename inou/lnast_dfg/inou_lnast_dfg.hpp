...
protected:
  ...
  void process_ast_stmts       (LGraph *dfg, const mmap_lib::Tree_index &stmt_parent);
  void process_ast_assign_op   (LGraph *dfg, const mmap_lib::Tree_index &ast_idx);
  ...
  Node_pin     setup_node_assign_and_target   (LGraph *dfg, const mmap_lib::Tree_index &ast_op_idx);
